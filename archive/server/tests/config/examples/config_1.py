...
config = ContinueConfig(
    ...
    system_message="I'll be asking for unit tests in pytest. Please provide thorough unit tests, without going overboard. The tests should run and work each time",
    temperature=0.5,
    custom_commands=[
        CustomCommand(
            name="test",
