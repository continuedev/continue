...
class DatabaseContextProvider extends BaseContextProvider {
  ...
  get deprecationMessage() {
    return "The database context provider is deprecated and may be removed in a later version. Please consider using a database MCP server like db-mcp-server (github.com/FreePeak/db-mcp-server) instead.";
  }
