...
class GitCommitContextProvider extends BaseContextProvider {
  ...
  get deprecationMessage() {
    return "The git commits context provider is now deprecated and will be removed in a later version. Please consider using the Git MCP (hub.docker.com/r/mcp/git) instead.";
  }
