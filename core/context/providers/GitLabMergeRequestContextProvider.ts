...
class GitLabMergeRequestContextProvider extends BaseContextProvider {
  ...
  get deprecationMessage() {
    return "The Gitlab Merge Request context provider is now deprecated and will be removed in a later version. Please consider using the GitLab MCP (hub.docker.com/r/mcp/gitlab) instead.";
  }
