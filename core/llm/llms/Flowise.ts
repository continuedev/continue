...
class Flowise extends BaseLLM {
  ...
  protected _initializeSocket(): Promise<{ socket: Socket, socketInfo: IFlowiseSocketManager }> {
    return new Promise((res, rej) => {
      ...
      const socketInfo: IFlowiseSocketManager = {
        ...
        internal: { hasNextTokenPromiseResolve: () => { }, hasNextTokenPromiseReject: () => { }, messageHistory: [] },
        getCurrentMessage: () => ''
      };
