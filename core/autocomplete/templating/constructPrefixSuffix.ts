import { getRangeInLines } from "../../util/ranges";
 ...
 *
 * Accepts pre-loaded file contents to avoid redundant file reads.
 */
export function constructInitialPrefixSuffix(
  ...
  const suffix = getRangeInLines(fileLines, {
    start: input.pos,
