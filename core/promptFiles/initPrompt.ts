...
Create a comprehensive ${initFilename} file in the .shadow-code/rules/ directory with the following sections:
...
## Step 4: Finalize
After creating the .shadow-code/rules/${initFilename} file, provide a summary of what you've created and remind the user to:
