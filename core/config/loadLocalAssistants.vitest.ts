...
describe("getAllDotContinueDefinitionFiles with fileExtType option", () => {
  beforeEach(() => {
    ...
    addToTestDir([
      ".granite-code/assistants/",
      [".granite-code/assistants/assistant1.yaml", "yaml content 1"],
      [".granite-code/assistants/assistant2.yml", "yaml content 2"],
      [".granite-code/assistants/assistant3.md", "markdown content 1"],
      [".granite-code/assistants/assistant4.txt", "txt content"],
    ]);
  });
  ...
  it("should return empty array when no files match the specified extension type", async () => {
    ...
    addToTestDir([
      ".granite-code/assistants/",
      [".granite-code/assistants/nonmatch1.txt", "txt content"],
      [".granite-code/assistants/nonmatch2.json", "json content"],
    ]);
  ...
  it("should filter by file extension case sensitively", async () => {
    ...
    addToTestDir([
      [".granite-code/assistants/assistant5.YAML", "uppercase yaml"],
      [".granite-code/assistants/assistant6.YML", "uppercase yml"],
      [".granite-code/assistants/assistant7.MD", "uppercase md"],
    ]);
