...
/**
 * We pass the ControlPlaneClient instead of the getter function
 * for getting the current ControlPlaneClient from the ConfigHandler,
 * because these PlatformProfileLoaders will get recreated with the
 * most current ControlPlaneClient when the sign-in status changes.
 */
