...
export default class DocsService {
  ...
  public getMaxNumberOfConcurrentIndexing(): number {
    return this.embeddingManager.getMaxNumberOfConcurrentIndexing();
  }

  public updateMaxNumberOfConcurrentIndexing(num: number): void {
    this.embeddingManager.updateNumberOfConcurrentIndexing(num);
  }

  public pokeEmbeddingManager(): void {
    this.embeddingManager.deployEmbedingProcess();
  }
}
