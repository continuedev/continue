...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .shadow-codeignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".shadow-codeignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .shadow-codeignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".shadow-codeignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.shadow-codeignore", "level3/"],
    ]);
    const result = await shouldIgnore(
