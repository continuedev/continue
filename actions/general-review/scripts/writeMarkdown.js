...
⚠️ AI review skipped: YutoAgentic CLI installation failed.
...
⚠️ YutoAgentic CLI returned an empty response. Please check the configuration.
`,
  cli_not_found: `## Code Review Summary

⚠️ YutoAgentic CLI is not properly installed. Please ensure @yutoagentic/cli is installed globally.
`,
  config_error: `## Code Review Summary

⚠️ YutoAgentic configuration error. Please verify that the assistant exists in YutoAgentic Hub.
`,
  auth_error: `## Code Review Summary

⚠️ YutoAgentic API authentication failed. Please check your YUTOAGENTIC_API_KEY.
`,
  generic_failure: `## Code Review Summary

⚠️ AI review failed. Please check the YutoAgentic API key and configuration.

### Troubleshooting
- Verify the YUTOAGENTIC_API_KEY secret is set correctly
- Check that the organization and config path are valid
- Ensure the YutoAgentic service is accessible
`,
};
