...
function StatusIndicator({ status }: { status: CheckState["status"] }) {
  switch (status) {
    case "pending":
...
function ElapsedTime({ check }: { check: CheckState }) {
...
export const CheckProgress: React.FC<CheckProgressProps> = ({
  checks,
  baseBranch,
  changedFileCount,
}) => {
