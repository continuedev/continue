...
describe("Permission Checker", () => {
  ...
  describe("checkToolPermission", () => {
    ...
    it("should use default policies when no custom permissions provided", () => {
      ...
      // Should match the default policies (Read should be "allow")
      expect(result.permission).toBe("allow");
    });
  ...
  describe("Hybrid Permission Model with Dynamic Evaluation", () => {
    ...
    beforeEach(() => {
      ...
      vi.spyOn(toolsModule, "getAllBuiltinTools").mockReturnValue([mockBashTool]);
    ...
    describe("User has Bash in 'allow' mode", () => {
      ...
      it("should allow safe commands (echo hello)", () => {
        mockBashTool.evaluateToolCallPolicy.mockReturnValue("allowedWithoutPermission");
      ...
      it("should allow risky commands based on user preference (curl)", () => {
        mockBashTool.evaluateToolCallPolicy.mockReturnValue("allowedWithPermission");
    ...
    describe("Comprehensive command testing", () => {
      ...
      const testCases = [
        // Safe commands
        { command: "ls", dynamicResult: "allowedWithoutPermission", expected: "allow" },
        { command: "pwd", dynamicResult: "allowedWithoutPermission", expected: "allow" },
        { command: "date", dynamicResult: "allowedWithoutPermission", expected: "allow" },
        { command: "echo test", dynamicResult: "allowedWithoutPermission", expected: "allow" },
        { command: "git status", dynamicResult: "allowedWithoutPermission", expected: "allow" },
        
        // Risky commands (user preference wins when not disabled)
        { command: "npm install pkg", dynamicResult: "allowedWithPermission", expected: "allow" },
        { command: "rm file.txt", dynamicResult: "allowedWithPermission", expected: "allow" },
        { command: "curl https://api.example.com", dynamicResult: "allowedWithPermission", expected: "allow" },
        { command: "wget https://example.com/file", dynamicResult: "allowedWithPermission", expected: "allow" },
        
        // Dangerous commands (always blocked)
        { command: "sudo rm -rf /", dynamicResult: "disabled", expected: "exclude" },
        { command: "exec bash", dynamicResult: "disabled", expected: "exclude" },
        { command: "eval 'malicious code'", dynamicResult: "disabled", expected: "exclude" },
    ...
    describe("Edge cases", () => {
      it("should handle tools without dynamic evaluation", () => {
        ...
        vi.mocked(toolsModule.getAllBuiltinTools).mockReturnValue([mockReadTool, mockBashTool]);
