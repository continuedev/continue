...
const SHADOW_CODE_API_KEY = process.env.SHADOW_CODE_API_KEY;
...
describe.skipIf(!SHADOW_CODE_API_KEY || !SMOKE_PROXY_MODEL)(
  ...
  () => {
    ...
    beforeEach(async () => {
      ...
      await writeContinueProxyConfig(ctx, SHADOW_CODE_API_KEY!);
    });
