...
async function copyConfigSchema() {
  ...
  // Modify and copy for .shadow-coderc.json
  ...
  schema.$defs.SerializedContinueConfig.properties.mergeBehavior = {
    ...
    markdownDescription:
      "If set to 'merge', .shadow-coderc.json will be applied on top of config.json (arrays and objects are merged). If set to 'overwrite', then every top-level property of .shadow-coderc.json will overwrite that property from config.json.",
    "x-intellij-html-description":
      "<p>If set to <code>merge</code>, <code>.shadow-coderc.json</code> will be applied on top of <code>config.json</code> (arrays and objects are merged). If set to <code>overwrite</code>, then every top-level property of <code>.shadow-coderc.json</code> will overwrite that property from <code>config.json</code>.</p>",
  };
  fs.writeFileSync(
    "shadow_code_rc_schema.json",
