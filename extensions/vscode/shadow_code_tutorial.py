...
# 3. Try asking Shadow Code to "make this more readable"
...
# 3. Try asking Shadow Code "what sorting algorithm is this?"
...
# 2. Use the "/init" slash command to generate an AGENTS.md file
