The `extensions/vscode` folder contains code for the "Yuto Agentic" VS Code Extension. Yuto Agentic is a coding extension which extends IDE functionality with AI.
