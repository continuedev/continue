...
tasks {
    ...
    test {
        useJUnitPlatform()
        environment("YUTOAGENTIC_GLOBAL_DIR", "${rootProject.projectDir}/src/test/kotlin/com/github/yutoagentic/yutoagenticintellijextension/test-yutoagentic")
...
val testIntegration = task<Test>("testIntegration") {
    ...
    environment("YUTOAGENTIC_GLOBAL_DIR", "${rootProject.projectDir}/src/testIntegration/kotlin/com/github/yutoagentic/yutoagenticintellijextension/test-yutoagentic")
    useJUnitPlatform()
