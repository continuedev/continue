package com.github.yutoagentic.yutoagenticintellijextension.nextEdit
...
//                val nextEditItem = processedItem?.let { convertToNextEditItem(it) }
    ...
    private fun parseProcessedItem(response: Any?): ProcessedItem? {
        return try {
            ...
            val range = com.github.yutoagentic.yutoagenticintellijextension.Range(startPosition, endPosition)
            val location = com.github.yutoagentic.yutoagenticintellijextension.RangeInFile(filepath, range)
