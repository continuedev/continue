...
import com.github.yutoagentic.yutoagenticintellijextension.constants.ContinueConstants
import com.github.yutoagentic.yutoagenticintellijextension.constants.getContinueGlobalPath
import com.github.yutoagentic.yutoagenticintellijextension.`continue`.file.FileUtils
...
import com.github.yutoagentic.yutoagenticintellijextension.utils.*
...
class IntelliJIDE(
    ...
    private val ADDITIONAL_SEARCH_IGNORE_FILETYPES = listOf(
        ...
        "*.gcno", "go.sum", "*.gitignore", "*.gitkeep", "*.yutoagenticignore",
    ...
    override suspend fun getSearchResults(query: String, options: com.github.yutoagentic.yutoagenticintellijextension.protocol.GetSearchResultsOptions?): String {
        val ideInfo = this.getIdeInfo()
        if (ideInfo.remoteName == "local") {
            try {
