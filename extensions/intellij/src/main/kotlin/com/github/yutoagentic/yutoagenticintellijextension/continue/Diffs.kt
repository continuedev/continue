...
import com.github.yutoagentic.yutoagenticintellijextension.utils.getAltKeyLabel
...
fun getDiffDirectory(): File {
    ...
    val diffDirPath = Paths.get(homeDirectory).resolve(".yutoagentic").resolve(".diffs").toString()
