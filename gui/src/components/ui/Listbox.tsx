  ...
  ({ fontSizeModifier = -3, ...props }, ref) => {
    ...
    return (
      <HLButton
        ...
        {...props}
        className={cn(
          "border-vsc-input-border bg-vsc-input-background text-vsc-foreground m-0 flex flex-1 cursor-pointer flex-row items-center gap-1 rounded-sm border border-solid px-1 py-0.5 text-left",
          props.className,
        )}
        style={{
          fontSize,
