  ...
  return (
    <div className="bg-vsc-editor-background mx-3 flex flex-col rounded-t-lg p-1">
      ...
      {codeToEdit.length > 0 ? (
        ...
        <div
          className="text-lightgray hover:bg-lightgray hover:text-vsc-foreground flex cursor-pointer items-center justify-center gap-1 rounded py-0.5 text-center text-xs transition-colors hover:bg-opacity-20"
