...
export function HistoryTableRow({
  ...
  return (
    <tr
      ...
      className="hover:bg-list-hover relative box-border flex w-full cursor-pointer overflow-hidden rounded-lg p-3"
      onClick={async () => {
    ...
    >
      ...
      {hovered && !editing && (
        <div className="bg-vsc-background absolute right-2 top-1/2 ml-auto flex -translate-y-1/2 transform items-center gap-x-1 rounded-full px-2 py-1 shadow-md">
