...
export default function PageHeader({
  ...
  return (
    <div className="bg-vsc-background sticky top-0 z-20 m-0 flex items-center justify-between border-0 border-b border-solid border-b-zinc-700 bg-inherit pb-1 pt-0.5">
