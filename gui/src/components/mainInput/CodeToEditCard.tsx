...
function CodeToEditItem({ code }: CodeToEditItemProps) {
  ...
  return (
    <div className="flex flex-col gap-1 py-0.5 pl-2">
      <div className="group flex flex-row items-center justify-start gap-1.5">
        <span
          className="hidden flex-shrink-0 font-semibold text-gray-400 sm:flex"
          style={{
            fontSize: smallFont,
          }}
        >
  ...
  return (
    <div className="bg-vsc-editor-background mx-3 flex flex-col rounded-t-lg py-1">
      {codeToEdit ? (
        ...
        //   Highlight code and select Cmd + I to edit a file
        // </span>
        <>
          <span
