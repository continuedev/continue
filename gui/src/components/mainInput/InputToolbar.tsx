  ...
  return (
    <>
      <div
        ...
        className={`find-widget-skip bg-vsc-input-background hover:bg-vsc-input-background/60 flex select-none flex-row items-center justify-between gap-1 pt-1 ${props.hidden ? "pointer-events-none h-0 cursor-default opacity-0" : "pointer-events-auto mt-2 cursor-text opacity-100"}`}
        style={{
          fontSize: smallFont,
        }}
      >
