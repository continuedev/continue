...
const granite34bCodeInstruct: ModelPackage = {
...
const granite8bCodeInstruct: ModelPackage = {
...
const granite3bCodeInstruct: ModelPackage = {
...
export const PROVIDER_INFO: { [key: string]: ModelInfo } = {
  ...
  ibm: {
    ...
    packages: [granite34bCodeInstruct, granite8bCodeInstruct, granite3bCodeInstruct],
  },
  mistral: {
    title: "Mistral API",
    provider: "mistral",
