...
To get started, [register](https://dataplatform.cloud.ibm.com/registration/stepone?context=wx) on watsonx SaaS, create your first project and setup an [API key](https://www.ibm.com/docs/en/mas-cd/continuous-delivery?topic=cli-creating-your-cloud-api-key).`,
  ...
  askSage: {
    ...
    packages: [
      // Claude models
      models.asksageclaude47opus,
      models.asksageclaude46opus,
      models.asksageclaude46sonnet,
      ...
      // GPT-5.x models
      models.asksagegpt54,
      models.asksagegpt54nano,
      models.asksagegpt54gov,
      models.asksagegpt52,
      models.asksagegpt51,
      models.asksagegpt51gov,
      models.asksagegpt5,
      ...
      models.asksagegpt41gov,
      models.asksagegpt41minigov,
      // GPT o-series models
      models.asksagegpto1,
      models.asksagegpto3,
      models.asksagegpt03mini,
      models.asksagegpt04mini,
      models.asksagegpto3minigov,
      // AWS Bedrock models
      ...
      models.asksagegptoss120b,
      models.asksagegptoss20b,
      // Groq models
