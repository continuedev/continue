...
export const models: { [key: string]: ModelPackage } = {
  ...
  mistralLarge: {
    ...
    icon: "mistral.png",
    providerOptions: ["mistral", "ask-sage"],
    isOpenSource: false,
  },
  geminiPro: {
    title: "Gemini Pro",
    ...
    icon: "gemini.png",
    providerOptions: ["gemini", "ask-sage"],
    isOpenSource: false,
  },
  gemini15Pro: {
  ...
  gpt4o: {
    ...
    providerOptions: ["openai", "free-trial", "ask-sage"],
    icon: "openai.png",
    isOpenSource: false,
  },
  gpt4omini: {
    ...
    providerOptions: ["openai", "ask-sage"],
    icon: "openai.png",
    isOpenSource: false,
  },
  gpt35turbo: {
  ...
  claude35Sonnet: {
    ...
    providerOptions: ["anthropic", "free-trial", "ask-sage"],
    icon: "anthropic.png",
    isOpenSource: false,
  },
  claude3Opus: {
    ...
    providerOptions: ["anthropic", "ask-sage"],
    icon: "anthropic.png",
    isOpenSource: false,
  },
  claude3Sonnet: {
  ...
  gpt4gov: {
    ...
    providerOptions: ["ask-sage", "openai"], 
    icon: "openai.png",
    isOpenSource: false,
  },
  gpt4ogov: {
