...
export const models: { [key: string]: ModelPackage } = {
  ...
  asksagegpt41gov: {
    title: "GPT-4.1 gov*",
    description: "OpenAI GPT 4.1 model approved for U.S. Government use.",
    params: {
      model: "gpt-4.1-gov",
  ...
  asksagegpt41minigov: {
    title: "GPT-4.1 mini gov*",
    description: "OpenAI GPT 4.1 mini model approved for U.S. Government use.",
    params: {
      model: "gpt-4.1-mini-gov",
      contextLength: 1_000_000,
      maxTokens: 32_768,
      title: "GPT-4.1 mini gov*",
      apiKey: "",
  ...
  asksagegpto3minigov: {
    title: "GPT-o3-mini gov*",
    description: "OpenAI GPT o3-mini model approved for U.S. Government use.",
    params: {
      model: "gpt-o3-mini-gov",
      contextLength: 200_000,
      maxTokens: 100_000,
      title: "GPT-o3-mini gov*",
      apiKey: "",
  ...
  asksagegpt51gov: {
    title: "GPT-5.1 gov*",
    description: "OpenAI GPT-5.1 model approved for U.S. Government use.",
    params: {
      model: "gpt-5.1-gov",
      contextLength: 400_000,
      maxTokens: 200_000,
  ...
  asksagegpt54: {
    title: "GPT-5.4*",
    description: "OpenAI's GPT-5.4 model.",
    params: {
      model: "gpt-5.4",
      contextLength: 400_000,
      maxTokens: 200_000,
  ...
  asksagegpt54nano: {
    title: "GPT-5.4 nano*",
    description: "OpenAI's GPT-5.4 nano model.",
    params: {
      model: "gpt-5.4-nano",
      contextLength: 400_000,
      maxTokens: 200_000,
  ...
  asksagegpt54gov: {
    title: "GPT-5.4 gov*",
    description: "OpenAI's GPT-5.4 model approved for U.S. Government use.",
    params: {
      model: "gpt-5.4-gov",
      contextLength: 400_000,
      maxTokens: 200_000,
  ...
  asksageclaude47opus: {
    ...
    description: "Anthropic's Claude Opus 4.7 model.",
    params: {
      model: "google-claude-47-opus",
      contextLength: 200_000,
      title: "Claude Opus 4.7*",
      apiKey: "",
    },
  ...
  asksagenovaprogov: {
    title: "Nova Pro gov*",
    description: "AWS Gov Nova Pro model.",
    params: {
      model: "aws-bedrock-nova-pro-gov",
      contextLength: 300_000,
      title: "Nova Pro gov*",
      apiKey: "",
    },
  ...
  asksagenovamicrogov: {
    title: "Nova Micro gov*",
    description: "AWS Gov Nova Micro model.",
    params: {
      model: "aws-bedrock-nova-micro-gov",
      contextLength: 128_000,
      title: "Nova Micro gov*",
      apiKey: "",
    },
  ...
  asksagetitan: {
    title: "Titan*",
    description: "AWS Bedrock Titan model.",
    params: {
  ...
  asksagenemotron12bvl: {
    title: "Nemotron 12B VL gov*",
    description: "NVIDIA Nemotron 12B vision-language model on AWS GovCloud.",
    params: {
      model: "aws-bedrock-nemotron-12b-vl-gov",
      contextLength: 128_000,
      title: "Nemotron 12B VL gov*",
      apiKey: "",
    },
  ...
  asksagenemotron9b: {
    title: "Nemotron 9B gov*",
    description: "NVIDIA Nemotron 9B model on AWS GovCloud.",
    params: {
      model: "aws-bedrock-nemotron-9b-gov",
      contextLength: 128_000,
      title: "Nemotron 9B gov*",
      apiKey: "",
    },
  ...
  asksagenemotron30b: {
    title: "Nemotron 30B gov*",
    description: "NVIDIA Nemotron 30B model on AWS GovCloud.",
    params: {
      model: "aws-bedrock-nemotron-30b-gov",
      contextLength: 128_000,
      title: "Nemotron 30B gov*",
      apiKey: "",
    },
  ...
  asksagegptoss120b: {
    title: "GPT OSS 120B gov*",
    description: "GPT OSS 120B model on AWS GovCloud.",
    params: {
      model: "aws-bedrock-gpt-oss-120b-gov",
      contextLength: 128_000,
      title: "GPT OSS 120B gov*",
      apiKey: "",
    },
  ...
  asksagegptoss20b: {
    title: "GPT OSS 20B gov*",
    description: "GPT OSS 20B model on AWS GovCloud.",
    params: {
      model: "aws-bedrock-gpt-oss-20b-gov",
      contextLength: 128_000,
      title: "GPT OSS 20B gov*",
      apiKey: "",
    },
  ...
  asksagegroqdeepseek: {
    title: "DeepSeek (Groq)",
    description: "DeepSeek model hosted on Groq infrastructure.",
    params: {
      title: "DeepSeek (Groq)",
      model: "groq-deepseek",
      contextLength: 128_000,
  ...
  asksagellma3: {
    title: "Llma 3",
    description: "Meta's Llma 3 large language model.",
    params: {
      title: "Llma 3",
      model: "llma3",
      contextLength: 128_000,
  ...
  asksagellma38b: {
    title: "Llma 3 8B",
    description: "Meta's Llma 3 8B model.",
    params: {
      title: "Llma 3 8B",
      model: "llma3-8b",
      contextLength: 128_000,
