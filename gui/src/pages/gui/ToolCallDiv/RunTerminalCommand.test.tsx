...
describe("RunTerminalCommand", () => {
  it("should display error message when tool call is errored", () => {
    ...
    expect(outputElement.textContent).toContain("This command has been disabled by security policy");
    expect(outputElement.textContent).toContain('eval "echo hello"');
    expect(outputElement.textContent).toContain("cannot be executed as it may pose a security risk");
  ...
  it("should detect failed status from error state", () => {
    ...
    const outputElement = screen.getByTestId("output");
    expect(outputElement.textContent).toContain("Command 'invalid-command' not found");
  ...
  it("should prioritize first output item for errored status", () => {
    ...
    const outputElement = screen.getByTestId("output");
    expect(outputElement.textContent).toContain("extremely dangerous and has been blocked");
