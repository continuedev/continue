...
All URIs are relative to *https://api.yutoagentic.dev*
...
# Defining the host is optional and defaults to https://api.yutoagentic.dev
# See configuration.py for a list of all supported configuration parameters.
configuration = openapi_client.Configuration(
    host = "https://api.yutoagentic.dev"
)
