...
/* eslint-disable */
/**
 * YutoAgentic Hub IDE API
 * API for YutoAgentic IDE to fetch assistants and other related information. These endpoints are primarily used by the YutoAgentic IDE extensions for VS Code and JetBrains.
 *
