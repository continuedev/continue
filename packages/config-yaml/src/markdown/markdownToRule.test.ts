...
---
  ...
  This is a test rule.`;
      ...
      const result = markdownToRule(content, {
        uriType: "file",
        uriPath: "/Documents/myproject/.continue/rules/rule1.md",
      });
...
describe("getRuleName", () => {
  ...
  it("should return last two path segments for file identifier when no name", () => {
    ...
    const id: PackageIdentifier = {
      uriType: "file",
      uriPath: "/long/path/to/rules/my-rule.md",
    };
  ...
  it("should handle file paths with backslashes", () => {
    ...
    const id: PackageIdentifier = {
      uriType: "file",
      uriPath: "C:\\long\\path\\to\\rules\\my-rule.md",
    };
  ...
  it("should handle mixed forward and back slashes", () => {
    ...
    const id: PackageIdentifier = {
      uriType: "file",
      uriPath: "/path/to\\rules/my-rule.md",
    };
  ...
  it("should prioritize frontmatter name over file path", () => {
    ...
    const id: PackageIdentifier = {
      uriType: "file",
      uriPath: "/very/long/path/to/rules/original-name.md",
    };
