...
API for Shadow Code IDE to fetch assistants and other related information.
These endpoints are primarily used by the Shadow Code IDE extensions for VS Code and JetBrains.
