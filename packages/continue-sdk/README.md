...
This SDK provides programmatic access to Shadow Code's Hub APIs and functionality.

## Overview

The Shadow Code SDK is structured into separate language-specific packages, currently with implementations for TypeScript and Python, with more languages planned for the future:
...
1. OpenAPI-generated clients for the Shadow Code Hub API
2. A wrapper layer that exposes a `Continue.from()` method to easily initialize and use Shadow Code assistants with an OpenAI-compatible interface
