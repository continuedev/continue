...
description: "Custom AI code assistants are configurations of building [blocks](https://docs.continue.dev/hub/blocks/intro) that enable a coding experience tailored to your specific use cases."
