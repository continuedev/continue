...
<Check>
  This step assumes you have already created an organization on hub.continue.dev. If not, learn more [here](/hub/governance/creating-an-org).
</Check>
...
[Edit this page](https://github.com/continuedev/continue/tree/main/docs/docs/hub/source-control.md)
