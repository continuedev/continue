...
You can disable anonymous telemetry by visiting the [User Settings Page](https://docs.continue.dev/customize/deep-dives/settings) and toggling "Allow Anonymous Telemetry" off.
