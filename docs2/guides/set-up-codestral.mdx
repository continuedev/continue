...
```json
{  "models": [    {      "title": "Codestral",      "provider": "mistral",      "model": "codestral-latest",      "apiKey": "<YOUR_CODESTRAL_API_KEY>",      "apiBase": "https://codestral.mistral.ai/v1"    }  ],  "tabAutocompleteModel": [    {      "title": "Codestral",      "provider": "mistral",      "model": "codestral-latest",      "apiKey": "<YOUR_CODESTRAL_API_KEY>",      "apiBase": "https://codestral.mistral.ai/v1"    }  ]}
```
...
[Edit this page](https://github.com/continuedev/continue/tree/main/docs/docs/guides/set-up-codestral.mdx)
