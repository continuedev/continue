...
```json
{  "contextProviders": [    {      "name": "http",      "params": {        "url": "https://myserver.com/retrieve",        "title": "http",        "description": "Custom HTTP Context Provider",        "displayTitle": "My Custom Context"      }    }  ]}
```
...
[Edit this page](https://github.com/continuedev/continue/tree/main/docs/docs/guides/custom-code-rag.mdx)
