...
Learn more in the [MCP deep dive](/customization/mcp-tools), and view [`mcpServers`](/reference#mcpservers) in the YAML Reference for more details. description: Model Context Protocol servers provide specialized functionality keywords: \[mcp, blocks, model context protocol, integrations, tools] sidebar_position: 4
