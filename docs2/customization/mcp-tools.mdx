...
Learn more in the [MCP deep dive](/customize/deep-dives/mcp), and view [`mcpServers`](/reference#mcpservers) in the YAML Reference for more details. description: Model Context Protocol servers provide specialized functionality keywords: \[mcp, blocks, model context protocol, integrations, tools] sidebar\_position: 4
...
[Edit this page](https://github.com/continuedev/continue/tree/main/docs/docs/customization/mcp-tools.mdx)
