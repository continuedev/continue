...
Continue supports [many model providers](/customize/model-providers/openai), including Anthropic, OpenAI, Gemini, Ollama, Amazon Bedrock, Azure, xAI, DeepSeek, and more. Models can have various roles like `chat`, `edit`, `apply`, `autocomplete`, `embed`, and `rerank`.

Read more about roles [here](/customize/model-roles/intro) and view [`models`](/reference#models) in the YAML Reference.

[Edit this page](https://github.com/continuedev/continue/tree/main/docs/docs/customization/models.mdx)
