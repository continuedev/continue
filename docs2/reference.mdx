...
<Note>
  ...
  Config YAML replaces [`config.json`](https://docs.continue.dev/json-reference), which is deprecated. View the **[Migration Guide](https://docs.continue.dev/yaml-migration)**.
</Note>
...
<CardGroup>
  <Card title="name" icon="square-check" horizontal href="#name"/>
  <Card title="version" icon="square-check" horizontal href="#version"/>
  <Card title="schema" icon="square-check" horizontal href="#schema"/>
  <Card title="models" icon="square-check" horizontal href="#models"/>
  <Card title="context" icon="square-check" horizontal href="#context"/>
  <Card title="rules" icon="square-check" horizontal href="#rules"/>
  <Card title="prompts" icon="square-check" horizontal href="#prompts"/>
  <Card title="docs" icon="square-check" horizontal href="#docs"/>
  <Card title="mcpServers" icon="square-check" horizontal href="#mcpservers"/>
  <Card title="data" icon="square-check" horizontal href="#data"/>
</CardGroup>
...
* `promptTemplates`: Can be used to override the default prompt templates for different model roles. Valid values are `chat`, [`edit`](https://docs.continue.dev/customize/model-roles/edit#prompt-templating), [`apply`](https://docs.continue.dev/customize/model-roles/apply#prompt-templating) and [`autocomplete`](https://docs.continue.dev/customize/model-roles/autocomplete#prompt-templating). The `chat` property must be a valid template name, such as `llama3` or `anthropic`.
...
More information about usage/params for each context provider can be found [here](https://docs.continue.dev/customize/context-providers)
...
List of rules that the LLM should follow. These are concatenated into the system message for all [Chat](/chat/how-to-use-it), [Edit](https://docs.continue.dev/edit/how-to-use-it), and [Agent](https://docs.continue.dev/agent/how-to-use-it) requests. See the [rules deep dive](https://docs.continue.dev/customize/deep-dives/rules) for details.
...
Destinations to which [development data](https://docs.continue.dev/customize/deep-dives/development-data) will be sent.
