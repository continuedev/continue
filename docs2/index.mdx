...
<CardGroup cols={2}>
  <Card title="Chat" icon="messages" href="/features/chat/quick-start" horizontal>
    to understand and iterate on code in the sidebar
  </Card>
  <Card title="Autocomplete" icon="sparkles" href="/features/autocomplete/quick-start" horizontal>
    to receive inline code suggestions as you type
  </Card>
  <Card title="Edit" icon="pen-to-square" href="/features/edit/quick-start" horizontal>
    to modify code without leaving your current file
  </Card>
  <Card title="Agent" icon="robot" href="/features/agent/quick-start" horizontal>
