...
<Frame>
  <img src="https://docs.continue.dev/assets/images/intro-0c302b9c15b890c251b1ad04586c880f.png" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Chat" icon="messages" href="/chat/how-to-use-it" horizontal>
    to understand and iterate on code in the sidebar
  </Card>
  <Card title="Autocomplete" icon="sparkles" href="/autocomplete/how-to-use-it" horizontal>
    to receive inline code suggestions as you type
  </Card>
  <Card title="Edit" icon="pen-to-square" href="https://docs.continue.dev/edit/how-to-use-it" horizontal>
    to modify code without leaving your current file
  </Card>
  <Card title="Agent" icon="robot" href="https://docs.continue.dev/agent/how-to-use-it" horizontal>
