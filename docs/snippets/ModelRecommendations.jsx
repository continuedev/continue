export const ModelRecommendations = ({ role = "all" }) => {
  ...
  const modelRecs = {
    agent_plan: {
      open: ["Qwen3 Coder (480B)", "Qwen3 Coder (30B)", "Devstral (27B)", "Devstral", "GLM 4.5 (355B)", "GLM 4.5 Air (106B)", "Kimi K2 (1T)", "gpt-oss (120B)", "gpt-oss (20B)"],
    ...
    chat_edit: {
      open: ["Qwen3 Coder (480B)", "Qwen3 Coder (30B)", "gpt-oss (120B)", "gpt-oss (20B)"],
      closed: ["[Claude Opus 4.1](https://hub.continue.dev/anthropic/claude-4-1-opus)", "[Claude Sonnet 4](https://hub.continue.dev/anthropic/claude-4-sonnet)", "[GPT-5](https://hub.continue.dev/openai/gpt-5)", "[Gemini 2.5 Pro](https://hub.continue.dev/google/gemini-2.5-pro)"],
    ...
    apply: {
      ...
      notes: "Open models are basically non-existent / not good enough for this model role"
    },
    embed: {
  ...
  return (
    <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '1rem' }}>
      <thead>
        <tr>
          <th style={{ textAlign: 'left', borderBottom: '1px solid #ddd', padding: '8px' }}>Model role</th>
          <th style={{ textAlign: 'left', borderBottom: '1px solid #ddd', padding: '8px' }}>Best open models</th>
          <th style={{ textAlign: 'left', borderBottom: '1px solid #ddd', padding: '8px' }}>Best closed models</th>
      ...
      <tbody>
        {rolesToShow.map((roleKey) => {
          ...
          return (
            <tr key={roleKey}>
              <td style={{ fontWeight: 600, verticalAlign: 'top', padding: '8px' }}>
