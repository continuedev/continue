...
Actions that generate inline diffs, like “/edit”, “/comment”, or right click actions, use the same prompt and response processing logic as [Edit](edit/how-it-works).

To learn how other slash commands work, see the full reference [here](../customize/slash-commands.mdx).
