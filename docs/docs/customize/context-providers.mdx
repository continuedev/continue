...
To use it, you need to add a documentation site to your config file. See the [docs](../customize/deep-dives/docs.md) page for more information.
...
See [Prompt Files](/customize/deep-dives/prompt-file.mdx). Prompt files are not added directly to the config file; prompt files are parsed and injected into the config automatically, to be used like other context providers.
