...
1. Select an open-source model to use for free [locally](../top-level/ollama.mdx), or
2. Add your own API key for [Anthropic](../top-level/anthropic.mdx) or [another LLM provider](/customize/model-providers)
