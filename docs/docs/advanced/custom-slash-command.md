...
description: Learn how to create and configure custom slash commands in Continue, including natural language prompts and custom functions using the Continue SDK.
keywords: [custom commands, slash commands, Continue configuration, natural language prompts, Continue SDK, custom functions]
---
