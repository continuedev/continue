...
description: Learn how to create and configure a custom context provider in Continue, including implementing normal, query, and submenu types, as well as using the Extension API for VSCode.
keywords: [custom context provider, Continue configuration, context items, submenu, query, VSCode extension, API]
---
