...
- **Call external tools and functions**. Unchain your LLM with the power of tools using [Agent](../features/agent/quick-start.mdx). Add custom tools using [MCP Servers](../customize/deep-dives/mcp.mdx)
...
- See the [Config Deep Dive](../customize/deep-dives/configuration.md) for more details on configuring local assistants.
