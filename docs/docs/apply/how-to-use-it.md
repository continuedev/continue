...
1. Click "Apply" on a code block in Chat
...
- **Apply**: This uses the Apply model to integrate the generated code into your current file
...
When you click "Apply", the Apply model analyzes both your original code and the generated code to create a precise diff that is applied to your file.
