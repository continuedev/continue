---
title: Autocomplete Quick Start
description: Get started with Continue's autocomplete feature
keywords: [autocomplete, quick start, getting started, code completion]
---
