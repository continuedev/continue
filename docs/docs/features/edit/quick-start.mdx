---
title: Edit Quick Start
description: Get started with Continue's edit feature for in-place code modifications
keywords: [edit, quick start, code modification, in-place editing]
---
...
Describe the changes you would like the model to make to your highlighted code. For edits, a good prompt should be relatively short and concise. For longer, more complex tasks, we recommend using [Chat](../chat/quick-start).
...
In VS Code, Edit is implemented in the extension sidebar with a similar interface to [Chat](../chat/how-it-works), and you can also enter Edit mode by using the Mode Selector below the main Chat input to select `Edit`.
