...
description: Understanding Continue's agent functionality and autonomous AI coding
keywords: [agent, AI, autonomous coding, tools, how it works]
---
...
:::info
In [Chat mode](../chat/quick-start), tools are **not** included in the request to the model.
:::
...
- **View repo map** (`view_repo_map`): request a copy of the repository map—same as the [Repo Map Context Provider](../../advanced/context-integration/custom-providers#repository-map)
