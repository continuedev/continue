...
View the exact prompt sent to the AI model in the [prompt logs](../../advanced/troubleshooting) for debugging and optimization.

### Context Providers

Learn more about how context providers work:

- [Codebase Context](../../advanced/context-integration/codebase)
- [Documentation Context](../../advanced/context-integration/documentation)
