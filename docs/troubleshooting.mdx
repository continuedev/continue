...
1. Not all models support tool/function calling. Models like GPT-3.5 or older Claude versions may not support tools.
...
If Continue's autodetection isn't working correctly, you can manually specify capabilities in your `config.yaml`:
