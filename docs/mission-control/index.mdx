---
title: "Yuto Agentic Mission Control"
description: "Yuto Agentic Mission Control is the control plane for cloud agents where teams create, monitor, and automate AI-powered workflows across their toolchain. Create Tasks, manage Agents, connect Integrations, and share with your team all in one place."
sidebarTitle: "Overview"
---

## What You Can Do in Mission Control

Mission Control is where developers and teams use Yuto Agentic to power everyday coding workflows. From quick one-off Tasks to fully automated pipelines, everything starts here with Cloud Agents (AI-powered).
...
<CardGroup cols={3}>
  ...
  <Card title="Create a Task" icon="plus" href="https://yutoagentic.dev">
    Start with a prompt and run an Agent on demand.
  </Card>

  <Card title="Build Workflows for Cloud Agents" icon="clock" href="https://yutoagentic.dev/agents/new">
    Automate work using GitHub triggers, cron schedules, or webhooks.
  </Card>

  <Card title="Add Integrations" icon="workflow" href="https://yutoagentic.dev/integrations">
