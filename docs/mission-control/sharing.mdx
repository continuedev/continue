...
<Note>
Profiles look the same for personal users and organizations. The only difference is visibility options: personal profiles can create *Public* or *Private* item. Organizations can also create *Organization-only* items.
</Note>
