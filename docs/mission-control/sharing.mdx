---
title: "Sharing"
description: "Connect with the Yuto Agentic community to discover, share, and collaborate on AI development tools."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Public" icon="globe">
    Available to everyone in Yuto Agentic Mission Control.  
...
<CardGroup cols={2}>
  <Card title="Join the Discussion" icon="people" href="https://github.com/continuedev/continue/discussions">
    Join thousands of developers using Yuto Agentic and share your experiences.
    </Card>
