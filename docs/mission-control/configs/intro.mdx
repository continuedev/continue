...
All configs follow the [`config.yaml`](/reference) format, whether you're using Mission Control interface or editing files locally. This ensures consistency between hub-managed and local configurations.
