...
[Connect GitHub in Mission Control →](https://yutoagentic.dev/integrations/github)

## Access and permissions

When connecting GitHub, you choose which repositories to grant access to and approve the requested permissions. These allow Yuto Agentic to read repository data and open pull requests on your behalf.
