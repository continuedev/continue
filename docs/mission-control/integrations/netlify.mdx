...
<Card
  ...
  icon="bolt"
  href="https://continue.dev/integrations/netlify"
>
...
<Tip>
Official workflow templates may expand over time as new patterns are validated. You can view, enable, and configure this workflow in **[Mission Control → Integrations → Netlify](https://continue.dev/integrations/netlify)**.
</Tip>
