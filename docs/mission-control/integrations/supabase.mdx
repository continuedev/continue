...
<Card
  ...
  icon="database"
  href="https://continue.dev/integrations/supabase"
>
...
<Tip>
Official workflow templates may expand over time as new patterns are validated. You can view, enable, and configure this workflow in **[Mission Control → Integrations → Supabase](https://continue.dev/integrations/supabase)**.
</Tip>
