...
<CardGroup cols={2}>
  ...
  <Card title="Netlify" icon="globe" href="/mission-control/integrations/netlify">
    Automate deployments and manage site configuration.
  </Card>
 <Card title="Sanity" icon="globe" href="/mission-control/integrations/sanity">
  Set up workflows that validate content and schemas on every PR.
 </Card>
 <Card title="Supabase" icon="globe" href="/mission-control/integrations/supabase">
