...
<Card title="Connect Continue to Slack to Help You Complete:" icon="slack" href="https://continue.dev/integrations/slack">
...
Click the agent link in Slack to view the agent's progress in [Mission Control](https://continue.dev).
...
1. Go to [continue.dev/settings/integrations](https://continue.dev/settings/integrations)
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Integration" icon="github" href="https://continue.dev/settings/integrations/github">
