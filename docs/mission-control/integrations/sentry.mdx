...
[Connect Sentry in Mission Control →](https://yutoagentic.dev/integrations/sentry)
...
Agents can access projects and issues you have permission to view. Approved permissions allow Yuto Agentic to analyze error events, read issue details, and create pull requests or GitHub issues on your behalf.
