...
<Card
  ...
  icon="file-text"
  href="https://continue.dev/integrations/sanity"
>
...
<Tip>
Official workflow templates may expand over time as new patterns are validated. You can view, enable, and configure this workflow in **[Mission Control → Integrations → Sanity](https://continue.dev/integrations/sanity)**.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="github"
    href="https://continue.dev/settings/integrations/github"
  >
