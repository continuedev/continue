...
<Steps>
  ...
  <Step title="Authorize Slack">
    ...
    Click the "Connect" button next in [the Slack Integration ](https://hub.continue.dev/integrations/slack)and authorize the app in your workspace.
...
Click the agent link in Slack to view the agent's progress in [Mission Control](https://hub.continue.dev/hub?type=agents).
