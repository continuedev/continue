...
<Card
  ...
  href="https://continue.dev/integrations/atlassian"
>
...
<Tip>
Official workflow templates may expand over time as new patterns are validated. You can view, enable, and configure this workflow in **[Mission Control → Integrations → Atlassian](https://continue.dev/integrations/atlassian)**.
</Tip>
