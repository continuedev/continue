...
<Tabs>
  <Tab title="🌐 Mission Control">
    **Interactive web interface**
    ...
    ```bash
    # Navigate to continue.dev/agents
...
A cloud agent that monitors vulnerabilities and automatically opens PRs with fixes.    
  ...
  <Card title="🗄️ Database Auditing" icon="database" href="https://continue.dev/continuedev/supabase-agent">
...
<CardGroup cols={2}>
  ...
  <Card title="CLI Guide" icon="terminal" href="/cli/quickstart">
    Learn to run agents from the command line
  </Card>

  <Card title="Mission Control" icon="desktop" href="https://continue.dev/agents">
