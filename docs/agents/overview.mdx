...
- **Local**: Place agent files in `.yutoagentic/agents/` in your repository. Version-controlled and shared with your team.
- **Cloud**: Created and managed on [yutoagentic.dev/agents](https://yutoagentic.dev/agents). Web UI for configuration, no file to commit.

Both run on Yuto Agentic's cloud infrastructure.
...
<Tabs>
  <Tab title="Mission Control">
    Trigger agents from the web interface at [yutoagentic.dev](https://yutoagentic.dev) and review results in real-time.
  </Tab>

  <Tab title="CLI interactive">
    ```bash
    yt --agent my-org/my-agent
    ```
  ...
  <Tab title="CLI headless">
    ```bash
    yt -p --agent my-org/my-agent "Run weekly security scan"
    ```
...
| | Checks | Agents |
|---|---|---|
| File location | `.yutoagentic/checks/` | `.yutoagentic/agents/` or yutoagentic.dev |
...
<CardGroup cols={2}>
  <Card title="Security Scanning" icon="shield-check" href="https://yutoagentic.dev/continuedev/snyk-continuous-ai-agent">
    `continuedev/snyk-continuous-ai-agent`

    Monitors vulnerabilities and automatically opens PRs with fixes.
  </Card>

  <Card title="GitHub Management" icon="github" href="https://yutoagentic.dev/continuedev/github-project-manager-agent">
    `continuedev/github-project-manager-agent`

    Triages issues and manages project workflows.
  </Card>

  <Card title="Analytics Insights" icon="chart-bar" href="https://yutoagentic.dev/continuedev/posthog-continuous-ai-agent">
    `continuedev/posthog-continuous-ai-agent`

    Analyzes user data and creates actionable tasks.
  </Card>

  <Card title="Performance Optimization" icon="gauge-high" href="https://yutoagentic.dev/continuedev/netlify-continuous-ai-agent">
    `continuedev/netlify-continuous-ai-agent`

    Monitors Core Web Vitals and optimizes deployments.
  </Card>

  <Card title="Database Auditing" icon="database" href="https://yutoagentic.dev/continuedev/supabase-agent">
    `continuedev/supabase-agent`

    Audits RLS security and generates migrations.
  </Card>

  <Card title="Data Pipelines" icon="arrows-rotate" href="https://yutoagentic.dev/continuedev/dlt-agent">
