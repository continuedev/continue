...
<Tip>
  If you haven't already, create an account and connect your GitHub repositories in [Mission Control](https://yutoagentic.dev/).
</Tip>

<Steps>
  <Step title="Navigate to Your Agents Page">
    Go to [Mission Control Agents page](https://yutoagentic.dev/agents) and select an existing workflow with a pre-configured Cloud Agent.
  </Step>
...
Before creating your own agent, let's see one in action! The fastest way to experience the power of Yuto Agentic agents is with our demo repository.
...
<Steps>
  ...
  <Step title="🎯 Access Mission Control">
    Go to [Mission Control](https://yutoagentic.dev/) and:
    - **Connect GitHub** and authorize Yuto Agentic when prompted
...
<Tabs>
  <Tab title="🌐 Mission Control">
    **Web interface for interactive use**
    ...
    Access at [yutoagentic.dev/agents](https://yutoagentic.dev/agents)
  </Tab>
  ...
  <Tab title="🤖 Headless Mode">
    **Automated execution for CI/CD**
    ...
    ```bash
    yt --agent continuedev/snyk-continuous-ai-agent -p "Run security scan" --auto
    ```
...
<CardGroup cols={2}>
  <Card title="Start Small" icon="seedling">
    Begin with tasks you're confident Yuto Agentic can handle, like fixing known bugs with simple solutions.
  </Card>
  
  <Card title="Practice Locally" icon="terminal">
    Test with [Yuto Agentic CLI](../guides/cli) in TUI mode before deploying automation.
  </Card>
...
<Info>
  **Learn More**: Explore advanced patterns and case studies on the [Continuous AI Blog](https://blog.yutoagentic.dev).
</Info>
