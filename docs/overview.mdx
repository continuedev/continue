...
<CardGroup cols={3}>
  ...
  <Card title="Clear Your Inbox Queue" icon="inbox" href="https://yutoagentic.dev/inbox">
...
## Integrations
<Note>
  Connect Yuto Agentic to your existing developer tools to automate the repetitive work you don't have time for.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Slack" icon="slack" href="/mission-control/integrations/slack">
    Mention <code>@Yuto Agentic</code> in Slack to trigger Agents and receive updates.
  </Card>
...
You can go to [Mission Control Integrations](https://yutoagentic.dev/integrations) for the full list of tools you can connect, or for more information see [the docs page](https://docs.yutoagentic.dev/mission-control/integrations).
...
<CodeGroup>
    ...
    ```bash yarn
    yarn global add @yutoagentic/cli
    ```

    ```bash pnpm
    pnpm add -g @yutoagentic/cli
    ```
...
Learn more about [extension features](https://docs.yutoagentic.dev/ide-extensions/quick-start) and how to [customize](https://docs.yutoagentic.dev/customize/overview) →

<CardGroup cols={2}>
  <Card
    title="VS Code"
    icon="code"
    href="https://marketplace.visualstudio.com/items?itemName=YutoAgentic.yutoagentic"
  >
