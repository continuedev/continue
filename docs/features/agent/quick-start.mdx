...
<script type="application/ld+json">
{
  ...
  "@type": "TechArticle",
  "headline": "Continue Agent Mode Quick Start Guide",
  "description": "Learn how to use Continue's Agent mode to automatically implement code changes, fix bugs, and run commands using AI-powered tools that can modify your codebase based on natural language instructions",
  "url": "https://docs.continue.dev/features/agent/quick-start",
  ...
  "mainEntity": {
    "@type": "Thing",
    "name": "Agent Mode",
    "description": "AI-powered coding assistant feature that can automatically implement code changes, fix bugs, and run commands using natural language instructions"
  },
  "articleSection": "Software Features",
  "keywords": ["AI coding agent", "code automation", "AI programming assistant", "Continue agent mode", "AI development tools"]
}
</script>
