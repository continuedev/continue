...
[Kimi K2](https://hub.continue.dev/togetherai/kimi-k2-instruct) from Moonshot AI

1. Get your API key from [Together AI](https://api.together.ai)
2. Add [Kimi K2](https://hub.continue.dev/togetherai/kimi-k2-instruct) to your assistant on Continue Hub
...
[Qwen Coder 3 480B](https://hub.continue.dev/togetherai/qwen3-coder-480b-a35b-instruct-fp8) from Qwen

1. Get your API key from [Together AI](https://api.together.ai)
2. Add [Qwen Coder 3 480B](https://hub.continue.dev/togetherai/qwen3-coder-480b-a35b-instruct-fp8) to your assistant on Continue Hub
3. Add `TOGETHER_API_KEY` as a [User Secret](https://docs.continue.dev/hub/secrets/secret-types#user-secrets) on Continue Hub [here](https://hub.continue.dev/settings/secrets)
4. Click `Reload config` in the assistant selector in the Continue IDE extension
