---
title: "Contributing to Yuto Agentic Documentation"
sidebarTitle: "Docs Contributions"
description: "Welcome to the Yuto Agentic documentation! We're excited that you want to contribute. This guide will help you get started with our documentation workflow and tools."
---
...
<Steps>
  <Step title="Go to GitHub Discussions">
    Visit the [Yuto Agentic GitHub Discussions](https://github.com/continuedev/continue/discussions) page.
  </Step>
  ...
  <Step title="Provide detailed information">
    ...
    - Your environment (OS, IDE, Yuto Agentic version)
  </Step>
</Steps>
...
<Info>
  ...
  **Important**: All issues should start as discussions. The Yuto Agentic team will determine if and when a discussion should be escalated to a GitHub issue.
  
</Info>

The Yuto Agentic team will review discussions and may:
...
## 🤖 AI-Powered Documentation with Yuto Agentic

We strongly encourage using Yuto Agentic's AI assistance to maintain consistency and quality in our documentation. Here are three ways to set this up:
...
<Steps>
  <Step title="Install the agent from Yuto Agentic Mission Control">
    Visit [the Docs Assistant - Mintlify in Mission Control](https://yutoagentic.dev/continuedev/docs-mintlify) and click "Install" to add it to your Yuto Agentic setup. This agent comes pre-configured with all our documentation standards.

    <Info>
    Learn more about Yuto Agentic Configs in our [config documentation](/guides/understanding-configs).
    </Info>
  </Step>
  ...
  <Step title="Use the agent">
    <Tabs>
      <Tab title="Command Line">
        ```bash
        # Install the Yuto Agentic CLI if you haven't already
        npm install -g @yutoagentic/cli
        
        # Use the agent from the command line
        yt "Create a new guide for using the Yuto Agentic CLI with Linear" --config continuedev/docs-mintlify
        ```
      </Tab>
      
      <Tab title="IDE">
        1. Open Yuto Agentic in your IDE
        2. Select the "Docs Assistant - Mintlify" agent from the model dropdown
        3. Ask it to help you create or edit documentation
        
        Example prompts:
        - "Create a new guide for using the Yuto Agentic CLI with Linear"
...
<Steps>
  ...
  <Step title="Add the Yuto Agentic Docs MCP">
    Install from Yuto Agentic Mission Control: https://yutoagentic.dev/continuedev/continue-docs-mcp
    
    This MCP provides context about Yuto Agentic's documentation structure and standards.
  </Step>
  
  <Step title="Add Mintlify formatting rules">
    Install from Yuto Agentic Mission Control: https://yutoagentic.dev/mintlify/technical-writing-rule
  ...
  <Step title="Use your custom agent">
    <Tabs>
      <Tab title="Command Line">
        ...
        yt --config your-org/your-agent-name "Create a new guide for API authentication"
        ```
      </Tab>
...
2. Add frontmatter:
   ...
   ---
   ```
3. Use the Yuto Agentic agent to help format your content
...
1. Use the Yuto Agentic agent with prompts like:
...
const example = "Hello, Yuto Agentic!";
```
````
...
3. **Format check**: Use the Yuto Agentic agent to validate Mintlify formatting
...
- **Use the Yuto Agentic agent**: It knows our documentation standards and will save you time
...
- **Yuto Agentic agent questions**: Check the [Yuto Agentic Mission Control page](https://yutoagentic.dev/continuedev/docs-mintlify)
...
Thank you for contributing to Yuto Agentic! Your efforts help make our documentation better for everyone. To learn more about contibuting to other parts of the project, check out our [main CONTRIBUTING guide](https://github.com/continuedev/continue/blob/main/CONTRIBUTING.md) 🎉
