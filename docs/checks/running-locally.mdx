...
If you don't have any checks yet, run `check init` to explore your codebase and generate checks tailored to your project. Or start from scratch with [Write Your First Check](/checks/quickstart).
