...
@Docs 使用 hub 中助手的 [`docs` 块](../../hub/blocks/block-types.md#docs) 。访问 hub [查看 `docs` 块](https://hub.continue.dev/explore/docs) 或 [创建你自己的](https://hub.continue.dev/new?type=block&block=docs) 。
