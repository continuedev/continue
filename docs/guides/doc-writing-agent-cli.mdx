---
title: "Automating Documentation Updates with Yuto Agentic CLI"
sidebarTitle: "Automating Documentation Updates with Yuto Agentic CLI"
description: "Learn how to create automated documentation generation workflows using Yuto Agentic CLI. Set up AI agents to analyze code changes and generate or update documentation automatically in GitHub workflows or local development."
---
...
This guide demonstrates how to create automated documentation generation based on code updates in a git branch using the Yuto Agentic CLI, either as part of your local workflow or as part of a GitHub workflow.

This process utilizes the **Yuto Agentic CLI** (`yt`) in **headless mode** to analyze changes and generate the necessary documentation, and commit and push the changes. The goal is to keep the workflow as simple as possible by using straightforward shell commands, Yuto Agentic CLI prompts, and basic git operations.

## Why Use Yuto Agentic CLI for Documentation?
...
<CardGroup cols={1}>
  <Card title="Install Yuto Agentic CLI" icon="terminal">
    Yuto Agentic CLI requires Node.js 20 or higher.
    
    <CLIInstall />
  </Card>

  <Card title="Yuto Agentic API Key" icon="key">
    Get your API key from [Yuto Agentic Mission Control](https://yutoagentic.dev/settings/api-keys) and set:
    ```bash
...
<Steps>
  <Step title="Environment Setup">
    Validate environment, install Yuto Agentic CLI, and set up authentication with API keys.
  </Step>
  ...
  <Step title="AI Documentation Generation">
    Use Yuto Agentic CLI with custom rules to analyze changes and generate or update documentation files.
    <Tip>
...
- **continue_config:** The Yuto Agentic agent configuration to use
  - Consider setting a default value if you have a default config your'd like to use
- **continue_org:** The Yuto Agentic org to use
...
jobs:
  write-docs:
    ...
    - name: Install Yuto Agentic CLI
      run: |
        echo "Installing Yuto Agentic CLI..."
        npm i -g @yutoagentic/cli

    - name: Verify Yuto Agentic CLI installation
      run: |
        echo "Checking Yuto Agentic CLI version..."
        yt --version || exit 1
    ...
    - name: Generate documentation with Yuto Agentic CLI
      run: |
        echo "Running Yuto Agentic agent to generate documentation..."
        yt --config <continue-user>/<agent-config> \
           --auto \
           --allow Write \
           -p \
           --prompt ./context.txt \
...
When using the Yuto Agentic CLI on your local machine, you can build workflows in various ways, one of which is by simply creating shell scripts that you can run, which call the CLI.
...
# Generate documentation with Yuto Agentic CLI
echo "Running Yuto Agentic agent to generate documentation..."
...
Ready to implement automated documentation with Yuto Agentic CLI? Here are some helpful resources to get you started:

<CardGroup cols={2}>
  <Card title="Yuto Agentic CLI Guide" icon="terminal" href="/guides/cli">
    Learn the fundamentals of using Yuto Agentic CLI for automated coding tasks and headless workflows.
  </Card>
  ...
  <Card title="Video: Leverage AI to help with your docs" icon="video" href="https://www.youtube.com/watch?v=rJ2taa8OLvY">
    Checkout this video from Tetrate about using Yuto Agentic Agents to help with writing your docs.
  </Card>

  <Card title="Yuto Agentic Mission Control" icon="users" href="https://yutoagentic.dev">
    Browse pre-built agents and configurations from the Yuto Agentic community.
  </Card>
</CardGroup>
