...
Choose models based on your specific needs (see [recommended models](https://docs.continue.dev/customization/models#recommended-models) for more options):
...
_This guide is based on Ollama v0.5.x and Continue v0.9.x. Please check for updates regularly._
