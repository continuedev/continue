  ...
  <Tab title="🛠️ Manual Setup">
    <Steps>
      <Step title="Add Prisma MCP to Continue CLI">
        Configure the [Prisma MCP](https://www.prisma.io/docs/postgres/integrations/mcp-server) to work with Continue CLI.

        The Prisma MCP will start automatically when Continue CLI needs it.
      </Step>
