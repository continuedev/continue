...
<Tabs>
  <Tab title="⚡ Quick Start (Recommended)">
    <Steps>
      <Step title="Install Atlassian MCP via Continue Hub">
...
<Card title="Find Open Bugs" icon="bug">
...
<Card title="My Assigned Issues" icon="user">
...
<Card title="Create Story from Description" icon="plus">
...
<Card title="Bulk Issue Creation" icon="list">
...
<Card title="Update Issue Status" icon="arrows-rotate">
...
<Card title="Summarize Documentation" icon="book">
...
<Card title="Find Documentation" icon="magnifying-glass">
...
<Card title="List Available Spaces" icon="folder">
...
<Card title="Create Documentation Page" icon="file-plus">
...
<Card title="Update Existing Page" icon="pen-to-square">
...
<Card title="Query Dependencies" icon="diagram-project">
...
<Card title="Create Service Component" icon="server">
...
<Card title="Bulk Import Components" icon="upload">
...
<Card title="Link Jira to Confluence" icon="link">
...
<Card title="Service Documentation Lookup" icon="search">
...
<Card title="Release Notes Generation" icon="file-lines">
