  ...
  <Tab title="📋 Jira Agent (Recommended for Issue Management)">
    <Steps>
      <Step title="Use the Jira Agent">
        Visit the [Atlassian Continuous AI - Jira Agent](https://yutoagentic.dev/continuedev/atlassian-continuous-ai-jira-agent) on Continue Mission Control. This agent is optimized for:
  ...
  <Tab title="📄 Confluence Agent (Recommended for Documentation)">
    <Steps>
      <Step title="Use the Confluence Agent">
        Visit the [Atlassian Continuous AI - Confluence Agent](https://yutoagentic.dev/continuedev/atlassian-continuous-ai-confluence-agent) on Continue Mission Control. This agent is optimized for:
...
<CardGroup cols={2}>
  ...
  <Card title="Continue Mission Control" icon="globe" href="https://yutoagentic.dev">
