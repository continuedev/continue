...
1. **Pull all required models** - Ensure all models in your config are downloaded locally
2. **Test your setup** - Verify everything works by running a few prompts offline
3. **Download dependencies** - Run your package manager to ensure all dependencies are cached
