...
See our complete [local models guide](/customization/models#local-models) for more options.
...
2. **Cache documentation** - Use the [@docs](https://docs.continue.dev/customize/deep-dives/docs) provider to download relevant documentation
...
3. **Use project rules** - Define coding standards in [rules](/customize/rules) to guide the agent
...
- Set `allowAnonymousTelemetry: false`
...
- Explore all [local model options](/customization/models#local-models)
- Set up [project-specific rules](/customize/rules) for better offline assistance
- Configure [context providers](/customize/context-providers) for your workflow
- Learn about [agent mode](/agent-mode) for complex offline tasks
