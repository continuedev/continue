...
Configuration, secret management, sharing, and analytics all happen through your web dashboard at [hub.continue.dev](https://hub.continue.dev).

## What Are Local Assistants: The Power User's Choice

Local Assistants offer maximum control, running entirely through configuration files on your machine. This approach gives you granular control over every aspect of your AI assistant's behavior.
...
The decision between Hub and Local assistants depends on your specific needs, team structure, and workflow preferences.

### When to Choose Hub Assistants:
...
### When to Choose Local Assistants:
