...
This guide shows you how to leverage these features through natural language with Shadow Code CLI!
...
Now you can use natural language prompts to analyze web performance. The Shadow Code agent automatically calls the appropriate Chrome DevTools MCP tools.
...
This workflow automatically validates web performance on pull requests using the Shadow Code CLI in headless mode. It records performance traces, extracts Core Web Vitals, and posts a summary report as a PR comment.
