...
- [Continue CLI](https://docs.yutoagentic.dev/guides/cli)
    ...
    **Perfect for:** Immediate results with optimized prompts and built-in performance analysis
    ...
    <Steps>
      <Step title="Add the Pre-Built Agent">
        Visit the [Chrome Dev Tools Agent](https://yutoagentic.dev/continuedev/chrome-dev-tools-agent) on Continue Mission Control and click **"Install Agent"** or run:
  ...
  <Tab title="🛠️ Manual Setup">
    <Steps>
      <Step title="Add Chrome DevTools MCP to Your Assistant">
        Visit the [Chrome DevTools MCP](https://yutoagentic.dev/google/chrome-devtools-mcp) on Continue Mission Control and add it to your assistant, or add this to your configuration:
...
<CardGroup cols={2}>
  ...
  <Card title="Continue Mission Control" icon="circle-nodes" href="https://yutoagentic.dev">
