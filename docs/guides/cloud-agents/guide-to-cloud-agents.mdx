...
<Tabs>
  <Tab title="On-Demand Tasks">
    ...
    You can trigger these agents manually (with Continue, you can use the [Continue CLI](../../cli/overview) or [Mission Control](../../mission-control))—when you need an AI agents to perform one-off task that you want to review.
