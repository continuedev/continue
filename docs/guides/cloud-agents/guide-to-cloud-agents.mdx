...
With Yuto Agentic, Cloud Agents run in [Mission Control](../../mission-control), where teams configure execution, connect tools, review outcomes, and decide which workflows become automated over time.
...
<Tabs>
  <Tab title="On-Demand Tasks">
    ...
    You can trigger agents manually (with Yuto Agentic, use the [Yuto Agentic CLI](../../cli/quickstart) or [Mission Control](../../mission-control)) when you need a one-off task that you want to review.
  ...
  <Tab title="Automated Workflows">
    ...
    <Card title="Example: Security Agent" icon="lock">
      ...
      A "[Security Agent](https://yutoagentic.dev/integrations/snyk)" automatically opens PRs for Snyk issues with high and critical security vulnerabilities and implements the fixes.
...
<AccordionGroup>
  ...
  <Accordion title="Context Access" icon="folder-open">
    ...
    - **Cloud Agents:** Full repository access + [integrated tools](https://yutoagentic.dev/integrations) (Sentry, Snyk, Linear, etc.)
...
<CardGroup cols={2}>
  <Card title="Explore Cloud Agent Integrations" icon="rocket" href="https://yutoagentic.dev/integrations">

    Browse ready-to-use AI agents in Yuto Agentic Mission Control.
  ...
  <Card title="Mission Control Setup" icon="terminal" href="https://yutoagentic.dev">

    Get started with Yuto Agentic Mission Control.
