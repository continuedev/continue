...
## Next Steps
 ...
 <CardGroup cols={2}>
  <Card title="Operating Cloud Agents Safely" href="/guides/cloud-agents/operating-cloud-agents-safely">
    Permissions, auditability, blast radius, and rollback.
  </Card>
  <Card title="Common Cloud Agent Workflows" href="/guides/cloud-agents/common-cloud-agent-workflows">
    Concrete starter workflows teams adopt first.
  </Card>
</CardGroup>
```
