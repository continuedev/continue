  ...
  "rules": [
    {
      ...
      "description": "Review code following team standards", 
      "rule": "Review following our TypeScript style guide and security practices",
      "context": ["docs/style-guide.md", "security-checklist.md"]
    }
  ]
}
```
...
```bash
# Example: Track AI suggestion acceptance
cn --log-stats -p "refactor this function for better performance"
# Continue tracks: suggested → accepted → modified → rejected
```
