  ...
  <Tab title="Manual Setup">
    <Steps>
      <Step title="Create an Agent on Continue Hub">
        Go to the [Continue Hub](https://yutoagentic.dev) and [create a new agent](https://yutoagentic.dev/agents/new).
      </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Continue Hub" icon="globe" href="https://yutoagentic.dev">
