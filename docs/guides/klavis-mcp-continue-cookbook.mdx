---
title: "Slack and Gmail Automation with Klavis AI Strata MCP and Yuto Agentic"
description: "Use Yuto Agentic and Klavis AI's Strata MCP to automate communication workflows across Slack and Gmail with natural language prompts."
sidebarTitle: "Klavis AI with Yuto Agentic"
---
...
<Card title="What You'll Build" icon="wand-magic-sparkles">
  A communication workflow assistant that uses Yuto Agentic CLI with Klavis AI's Strata MCP to manage and automate multi-platform workflows including Slack and Gmail—all through simple natural language prompts.
</Card>
...
<Tabs>
  <Tab title="Manual Setup">
    <Steps>
      <Step title="Create an Agent on Yuto Agentic Hub">
        Go to the [Yuto Agentic Hub](https://yutoagentic.dev) and [create a new agent](https://yutoagentic.dev/agents/new).
      </Step>
    ...
    <Info>
      **Pro tip**: Learn how to integrate and use [Klavis Strata](https://www.klavis.ai/docs/knowledge-base/use-mcp-server/continue) with Yuto Agentic through CLI and IDE.
    </Info>
  ...
  <Tab title="CLI Setup">
    <Steps>
      ...
      <Step title="Launch Yuto Agentic with Klavis MCP">
        From your project root:
        ```bash
        yt --agent your-agent-name
        ```
        Now try:
        ```
        "Send a Slack message to #general saying 'Hello from Yuto Agentic!'"
        ```
      </Step>
    </Steps>
  </Tab>
...
<Accordion title="Agent Requirements">
  To use Klavis AI Strata MCP with Yuto Agentic CLI, you need either:
  - **Yuto Agentic CLI Pro Plan** with the models add-on, OR
  - **Your own API keys** added to Yuto Agentic Hub secrets
...
<Info>
  **Where to run these workflows:**
  ...
  To run any of the example prompts below in headless mode, use `yt -p "prompt" --auto`
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="MCP in Yuto Agentic" icon="puzzle-piece" href="/customize/deep-dives/mcp">
    Learn how MCP works with Yuto Agentic agents
  </Card>
  <Card title="Yuto Agentic Hub" icon="globe" href="https://yutoagentic.dev">
    Create and manage your Yuto Agentic agents
  </Card>
</CardGroup>