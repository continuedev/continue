...
sidebarTitle: "Automated Error Analysis with Sentry MCP"
---
...
<Tabs>
  <Tab title="⚡ Quick Start (Recommended)">
    **Perfect for:** Immediate error analysis with AI-powered root cause detection
    ...
    <Info>
      **Why Use Sentry MCP?** Direct integration with Sentry's API provides more reliable error data access and enables AI-powered analysis.
    </Info>
