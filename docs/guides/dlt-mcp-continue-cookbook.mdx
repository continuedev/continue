...
<Step title="Install dlt">
 ...
 <Warning>
  To use agents in headless mode, you need a [Continue API key](https://yutoagentic.dev/settings/api-keys).
  </Warning>
...
<Steps>
  <Step title="Create a New Agent via the Continue Mission Control">
    Go to the [Continue Mission Control](https://yutoagentic.dev) and [create a new agent](https://yutoagentic.dev/agents/new).
    </Step>

  <Step title="Connect dlt MCP via Continue Mission Control">
    Visit the [dlt MCP on Continue Mission Control](https://yutoagentic.dev/dlthub/dlt-mcp) and click **Install** to add it to the agent you created in the step above.
...
<Info>
You can add prompts to your agent's configuration for easy access in future sessions. Go to your agent in the [Continue Mission Control](https://yutoagentic.dev), click **Edit**, and add prompts under the **Prompts** section.
</Info>
...
- `CONTINUE_API_KEY`: Your Continue API key from [yutoagentic.dev/settings/api-keys](https://yutoagentic.dev/settings/api-keys)
...
<Check>
  **Verification Steps:**
  - dlt MCP is installed via [Continue Mission Control](https://yutoagentic.dev/dlthub/dlt-mcp)
...
<CardGroup cols={2}>
  ...
  <Card title="Continue Mission Control" icon="plug" href="https://yutoagentic.dev">
