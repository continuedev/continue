  ...
  <Tab title="⚡ Quick Start (Recommended)">
    <Steps>
      <Step title="Install GitHub MCP via Continue Hub">
        Visit the [Anthropic GitHub MCP](https://hub.continue.dev/anthropic/github_mcp) on Continue Hub and click **Install** to add it to your agent.
    ...
    <Info>
      You can also attach an MCP to a one-off session: `cn --mcp anthropic/github_mcp`.
    </Info>
  </Tab>
...
<CardGroup cols={2}>
  <Card title="GitHub MCP (Anthropic)" icon="link" href="https://hub.continue.dev/anthropic/github_mcp">
