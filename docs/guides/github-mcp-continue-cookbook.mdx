...
<Step title="Configure GitHub Token">
  Add your `GITHUB_TOKEN` to your [Continue Mission Control agent's environment variables](https://yutoagentic.dev/settings).
  </Step>
</Steps>
  ...
  <Tab title="⚡ Quick Start (Recommended)">
    <Steps>
      <Step title="Install GitHub MCP via Continue Mission Control">
        Visit the [GitHub Project Manager Agent](https://yutoagentic.dev/continuedev/github-project-manager-agent) on Continue Mission Control and click **Install** to add it to your agent.
