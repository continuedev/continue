...
<CardGroup cols={2}>
  <Card
    title="Building Async Agents with Yuto Agentic CLI"
    icon="blog"
    href="https://blog.yutoagentic.dev/building-async-agents-with-continue-cli/"
  >
  ...
  <Card
    ...
    icon="book"
    href="https://docs.yutoagentic.dev/guides/continuous-ai"
  >
