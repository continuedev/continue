...
<CardGroup cols={3}>
  <Card title="Privacy-First" icon="shield">
    The Continue CLI runs in your GitHub Actions runner and sends code directly to your configured LLM provider (OpenAI, Anthropic, etc.). No hosted Continue service reads your code - all logs and processing happen in your runner.
