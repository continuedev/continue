...
- A Continue API key from [yutoagentic.dev/settings/api-keys](https://yutoagentic.dev/settings/api-keys)
    ...
    steps:
      ...
      - name: Post Review Comment
        ...
        run: |
          ...
          ---
          *Powered by [Continue](https://yutoagentic.dev) • Need a focused review? Comment `@review-bot check for [specific concern]`*
          EOF
...
>
> ---
> *Powered by [Continue](https://yutoagentic.dev) • Need a focused review? Comment `@review-bot check for security`*
