...
<Card title="Fastest Path to Success" icon="rocket">
  Use the pre-built [Docs Assistant - Mintlify agent](https://yutoagentic.dev/continuedev/docs-mintlify) that includes the Continue Docs MCP and is ready to use immediately.
</Card>
...
<Tabs>
  ...
  <Tab title="🛠️ Custom Agent">
    ...
    1. [Continue Docs MCP](https://yutoagentic.dev/continuedev/continue-docs-mcp)
...
<Steps>
  ...
  <Step title="Publish to Continue Mission Control">
    Share your docs MCP on [Continue Mission Control](https://yutoagentic.dev/new?type=mcp) so others can use it with Continue agents.
  </Step>
</Steps>
