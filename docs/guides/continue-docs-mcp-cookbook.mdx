---
title: "Contributing to Yuto Agentic with Model Context Protocol (MCP)"
description: "Use the Yuto Agentic Docs MCP to write cookbooks, guides, and documentation with AI-powered workflows."
sidebarTitle: "Yuto Agentic Docs MCP Cookbook"
---

<Card title="What You'll Build" icon="book-open-cover">
  Master using the Yuto Agentic Docs MCP to contribute documentation, create cookbooks, and maintain consistency across Yuto Agentic's docs - all through natural language prompts.
</Card>
...
- Read: [Contributing to Yuto Agentic Documentation](/CONTRIBUTING) for setup instructions
- Forked the [continuedev/continue](https://github.com/continuedev/continue) repository
- Node.js 20+ and Yuto Agentic CLI installed

<Warning>
  This cookbook assumes you've read the setup in the [CONTRIBUTING guide](/CONTRIBUTING). If you haven't, start there first.
</Warning>

## Yuto Agentic Docs MCP Setup

<Card title="Fastest Path to Success" icon="rocket">
  Use the pre-built [Docs Assistant - Mintlify agent](https://yutoagentic.dev/continuedev/docs-mintlify) that includes the Yuto Agentic Docs MCP and is ready to use immediately.
</Card>

<Tabs>
  <Tab title="⚡ Quick Start (Recommended)">
    ```bash
    # From your Yuto Agentic docs directory
    yt --config continuedev/docs-mintlify
    ```

    This agent includes:
    - **Yuto Agentic Docs MCP** for searching Yuto Agentic documentation
  ...
  <Tab title="🛠️ Custom Agent">
    ...
    1. [Yuto Agentic Docs MCP](https://yutoagentic.dev/continuedev/continue-docs-mcp)
    2. [Mintlify Technical Writing Rule](https://yutoagentic.dev/mintlify/technical-writing-rule)
...
## What is the Yuto Agentic Docs MCP?

<Card title="Yuto Agentic Docs MCP" icon="circle-info">
  A Model Context Protocol server built with [Mintlify's MCP generation](https://www.mintlify.com/blog/generate-mcp-servers-for-your-docs) that enables semantic search across Yuto Agentic documentation. [Learn more →](/reference/continue-mcp)
</Card>

The MCP helps you:
- **Find examples** from existing documentation
- **Maintain consistency** with established patterns
- **Source accurate information** about Yuto Agentic features
...
Cookbooks show how to use Yuto Agentic CLI with specific tools or services. Here's how to create one using the Yuto Agentic Docs MCP:
...
<Steps>
  <Step title="Research Existing Cookbooks">
    ...
    **Prompt:**
    ```
    "Show me the structure of existing MCP cookbooks in the Yuto Agentic docs.
  ...
  <Step title="Source Official Documentation">
    **Prompt:**
    ```
    "Using the Yuto Agentic Docs MCP, find information about how GitHub MCP works.
    ...
    The agent will:
    - Search Yuto Agentic docs for MCP patterns
...
<Info>
  **Pro Tip:** The agent uses the Yuto Agentic Docs MCP to maintain consistency with existing cookbooks automatically.
</Info>
...
<Steps>
  ...
  <Step title="Make Targeted Updates">
    **Prompt:**
    ...
    to include information about the new Slack MCP server. Use the Yuto Agentic
...
<Steps>
  <Step title="Research Similar Content">
    **Prompt:**
    ```
    "I want to create a guide for setting up Yuto Agentic with Amazon Bedrock.
    Search the Yuto Agentic docs for similar model provider setup guides and
  ...
  <Step title="Create the Guide">
    **Prompt:**
    ...
    Use the Yuto Agentic Docs MCP to find accurate information about Yuto Agentic's
...
**Prompt:**
```
"Create a cookbook for using Yuto Agentic with PostgreSQL MCP. Follow the same
...
Use the Yuto Agentic Docs MCP to find MCP configuration patterns and search the
...
**Prompt:**
```
"Create a cookbook showing how to use Yuto Agentic to analyze Sentry errors.
...
**Prompt:**
```
"I want to create a cookbook for using Yuto Agentic to work with OpenAPI specs.

Show how to:
1. Load OpenAPI specs into Yuto Agentic's context
2. Generate API client code from specs
3. Create tests based on API endpoints
4. Update documentation when APIs change

Use the Yuto Agentic Docs MCP to find how context providers work, then combine
...
<CardGroup cols={2}>
  <Card title="Multi-Source Research" icon="magnifying-glass">
    ```bash
    "Use the Yuto Agentic Docs MCP to understand how agents
    work in Yuto Agentic, then search the web for Anthropic's
    Computer Use MCP. Create a cookbook showing how to
    combine Yuto Agentic agents with Computer Use for
    automated testing."
    ```
  </Card>
  ...
  <Card title="Cross-Reference Documentation" icon="link">
    ```bash
    "Find all mentions of MCP servers across Yuto Agentic
  ...
  <Card title="Example Extraction" icon="code">
    ...
    configuration from the Yuto Agentic docs. Format them
...
Add automated documentation checks to your PR workflow using the Yuto Agentic Docs MCP agent:
    ...
    steps:
      ...
      - name: Analyze Changes for Documentation Needs
        ...
        run: |
          ...
          # Use Yuto Agentic agent to check if docs need updates
          ...
          yt --config continuedev/docs-mintlify -p "$PROMPT" --auto > analysis.md || {
...
- [Yuto Agentic Docs MCP Cookbook](/guides/continue-docs-mcp-cookbook)

*This analysis was generated using the Yuto Agentic Docs MCP agent.*
EOF
...
<Info>
  This workflow uses the Yuto Agentic Docs MCP agent to analyze code changes and automatically comment on PRs when documentation updates are recommended.
</Info>
...
<Steps>
  ...
  <Step title="Publish to Yuto Agentic Mission Control">
    Share your docs MCP on [Yuto Agentic Mission Control](https://yutoagentic.dev/new?type=mcp) so others can use it with Yuto Agentic agents.
  </Step>
</Steps>

<Info>
  The [Yuto Agentic Docs MCP](/reference/continue-mcp) itself was built this way!
</Info>
...
| Task | Prompt |
|:-----|:-------|
| **Find structure** | "Show me the structure of existing cookbooks in Yuto Agentic docs" |
| **Create cookbook** | "Create a cookbook for [tool] MCP following the dlt cookbook structure" |
| **Update docs** | "Update [file] to include information about [feature], using Yuto Agentic Docs MCP to find examples" |
| **Add navigation** | "Add [file] to docs.json under the [section] section" |
| **Check consistency** | "Review this file for consistency with other Yuto Agentic documentation" |
| **Fix formatting** | "Review for Mintlify formatting issues and fix any problems" |
| **Extract examples** | "Find all examples of [topic] in Yuto Agentic docs" |
| **Research feature** | "Use Yuto Agentic Docs MCP to explain how [feature] works in Yuto Agentic" |

---

## Resources

### Yuto Agentic Documentation
- [Contributing Guide](/CONTRIBUTING) - Setup and submission process
- [Yuto Agentic Docs MCP Reference](/reference/continue-mcp) - MCP server details
...
<CardGroup cols={2}>
  ...
  <Card title="Use Docs Agent" icon="robot" href="https://yutoagentic.dev/continuedev/docs-mintlify">
