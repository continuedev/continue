...
Hub items are identified by slugs in the format `owner/item-name`. For example, to use the [OpenAI GPT-4o model](https://hub.continue.dev/openai/gpt-4o), you'd reference it as `openai/gpt-4o`.
