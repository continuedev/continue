...
description: "Learn how Cloud Agents can automate your development workflows by connecting to your codebase and tools."
sidebarTitle: "Guide to Cloud Agents"
---
...
Cloud agents are AI agents that run continuously in the cloud, connected directly to your development and production systems. Unlike local or IDE-only AI agents, cloud agents respond to real events, alerts, pull requests, deployments and take action automatically or can be enabled manually.
...
### The Four Components of a Cloud Agent

Unlike a simple script, a Cloud Agent combines four distinct components to reason through problems:
