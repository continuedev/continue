...
- [Supabase Database Workflow Cookbook](/guides/supabase-mcp-database-workflow) - Build intelligent database workflows with Supabase MCP for query optimization, schema analysis, and automated migrations
