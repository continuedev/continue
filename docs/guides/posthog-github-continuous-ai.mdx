...
- [Continue CLI](https://docs.yutoagentic.dev/guides/cli) with **active credits** (required for API usage)
...
<Steps>
  ...
  <Step title="Set up Continue CLI Account & API Key">
        1. Visit [Continue Organizations](https://yutoagentic.dev/settings/organizations)
...
1.  Go to the [Continue Mission Control](https://yutoagentic.dev)
...
<Tabs>
    ...
    **Perfect for:** Immediate results with optimized prompts and built-in debugging
    ...
    <Steps>
      <Step title="Add the Pre-Built Agent">
        Visit the [PostHog Continuous AI Agent](https://yutoagentic.dev/continuedev/posthog-continuous-ai-agent) on Continue Mission Control and click **"Install Agent"** or run:
  ...
  <Steps>
    <Step title="Add PostHog MCP to Continue CLI">
      First, install the [PostHog MCP](https://yutoagentic.dev/posthog/http-mcp) to the Continue CLI by
...
- [GitHub MCP on Continue Mission Control](https://yutoagentic.dev/github/github-mcp) (alternative option)
- [Continue CLI Guide](https://docs.yutoagentic.dev/guides/cli)
