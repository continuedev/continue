...
<Card title="Community" icon="cloud">
Pre-built models, rules, and tools from the Continue community that you can import and use
</Card>
</Columns>
...
Secrets are read from `.env` files in the following locations:
...
- **[Continue Community](https://continue.dev)**: Browse community models, rules, and tools
