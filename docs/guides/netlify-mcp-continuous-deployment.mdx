...
description: "Optimize web performance with A/B testing, automated monitoring, and data-driven improvements using Netlify MCP and Yuto Agentic."
...
This guide shows you how to leverage these features through natural language with Yuto Agentic CLI!
...
- [Yuto Agentic CLI](https://docs.yutoagentic.dev/guides/cli)
- [Netlify MCP](https://yutoagentic.dev/netlify/netlify-mcp) configured
- [Netlify Development Rules](https://yutoagentic.dev/netlify/netlify-development) (recommended)
  ...
  <Tab title="⚡ Quick Start (Recommended)">
    ...
    <Steps>
      <Step title="Add the Pre-Built Agent">
        Visit the [Netlify Continuous AI Agent](https://yutoagentic.dev/continuedev/netlify-continuous-ai-agent) on Yuto Agentic Mission Control and click **"Install Agent"** or run:
        
        ```bash
        yt --agent continuedev/netlify-continuous-ai-agent
        ```
      ...
      <Step title="Run Performance Analysis">
        ...
        ```bash
        yt "Analyze my Netlify site's performance and optimize it for better Core Web Vitals."
        ```
...
<Step title="Configure Netlify MCP">
  ...
  `netlify login`
  2. Visit [Netlify MCP on Yuto Agentic
  Hub](https://yutoagentic.dev/netlify/netlify-mcp)
  3. Follow the configuration instructions for your editor

</Step>

  <Step title="Add Development Rules">
    Install the [Netlify Development Rules](https://yutoagentic.dev/netlify/netlify-development) bundle for best practices:

    1. Visit the bundle page on Yuto Agentic Mission Control
  ...
  <Step title="Verify Setup">
    Test the connection with yt CLI:
 ...
 <Info>
    You're all set! Now you can use yt CLI to interact with Netlify using natural language prompts. Check out the examples below to get started.
  </Info>
  </Tab>
</Tabs>
...
Establish your current performance baseline using yt CLI:

```bash
# Start yt in TUI mode
yt
...
<Tip>
  **Discover more optimization prompts!** The Netlify community has documented dozens of build optimization strategies in their [Support Guide: How can I optimize my Netlify build time](https://answers.netlify.com/t/support-guide-how-can-i-optimize-my-netlify-build-time/3907). 
  ...
  Use this guide as inspiration for yt CLI prompts not covered in this cookbook, such as:
  ...
  The community guide contains real-world scenarios that you can turn into AI-assisted solutions - just describe what you want to achieve and let yt CLI handle the implementation!
</Tip>
...
jobs:
  performance:
    ...
    steps:
      ...
      - name: Authenticate Yuto Agentic CLI
        env:
          CONTINUE_API_KEY: ${{ secrets.CONTINUE_API_KEY }}
        run: |
          yt auth login --api-key "$CONTINUE_API_KEY"
          echo "✅ Yuto Agentic CLI authenticated"
      ...
      - name: Deploy and Test Performance
        ...
        run: |
          ...
          yt -p "Deploy PR preview and run Lighthouse.
...
| Issue         | Quick Fix Command (in yt TUI)     |
| ------------- | --------------------------------- |
...
```bash
# Try these advanced features in yt TUI mode:
...
- Install [Netlify MCP](https://yutoagentic.dev/netlify/netlify-mcp) from Yuto Agentic Mission Control
...
- [Netlify MCP on Yuto Agentic Mission Control](https://yutoagentic.dev/netlify/netlify-mcp)
- [Core Web Vitals Guide](https://web.dev/vitals/)
- [Netlify Analytics Documentation](https://docs.netlify.com/analytics/)
- [Yuto Agentic Performance Guides](https://docs.yutoagentic.dev/guides)
