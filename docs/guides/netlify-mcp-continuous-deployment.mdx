...
jobs:
  performance:
    ...
    steps:
      ...
      - name: Authenticate Shadow Code CLI
        env:
          CONTINUE_API_KEY: ${{ secrets.CONTINUE_API_KEY }}
        run: |
          cn auth login --api-key "$CONTINUE_API_KEY"
          echo "✅ Shadow Code CLI authenticated"
...
- Install the Netlify MCP in your Shadow Code configuration
...
- Shadow Code Performance Guides
