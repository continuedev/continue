...
<Steps>
  ...
  <Step title="Configure Netlify MCP">
    1. Visit [Netlify MCP on Continue Hub](https://hub.continue.dev/netlify/netlify-mcp)
    2. Follow the configuration instructions for CLI
    3. Add your Netlify Personal Access Token to your MCP config
  </Step>
