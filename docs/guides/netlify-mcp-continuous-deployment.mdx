...
<Tabs>
  <Tab title="⚡ Quick Start (Recommended)">
    **Perfect for:** Immediate results with optimized prompts and built-in debugging
    ...
    <Info>
      **Why Use the Agent?** Results are more consistent and debugging is easier thanks to the Netlify MCP integration and pre-tested prompts.
    </Info>
...
<Step title="Configure Netlify MCP">
  ...
  `netlify login` 
  3. Visit [Netlify MCP on Continue
