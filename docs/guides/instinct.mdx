---
title: "Using Instinct with Ollama in Shadow Code"
description: "Learn how to run Instinct, Shadow Code's leading open Next Edit model, on your own hardware with Ollama"
---
...
Alternatively, you can just click to add the block at 
