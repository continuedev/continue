...
<Check>
  ...
  <ul>
    <li>Snyk MCP is installed via <a href="https://hub.continue.dev/snyk/snyk-mcp">Continue Hub</a></li>
    <li>Secure-at-Inception rules are <a href="https://hub.continue.dev/snyk/secure-at-inception">enabled</a></li>
    <li>Authentication completed successfully</li>
    <li>Project folder has been trusted</li>
  </ul>
</Check>
