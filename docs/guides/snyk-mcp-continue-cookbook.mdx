...
<Check>
  **Verification Steps:**
  - Snyk MCP is installed via [Continue Hub](https://hub.continue.dev/snyk/snyk-mcp)
  - Secure-at-Inception rules are [enabled](https://hub.continue.dev/snyk/secure-at-inception)
