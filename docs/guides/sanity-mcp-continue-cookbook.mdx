---
title: "Content Management with Sanity MCP and Shadow Code"
...
sidebarTitle: "Sanity CMS with Shadow Code"
---
...
<Card title="What You'll Build" icon="database">
  An AI-powered content management system workflow that uses Shadow Code's AI agent with Sanity
...
<Step title="Install Sanity CLI">
 ...
 <Warning>
  To use agents in headless mode, you need a Shadow Code API key and proper environment variable configuration.
  </Warning>
...
<Steps>
  <Step title="Add Sanity MCP to Shadow Code CLI">
    ...
    <Tip>
      **Installation methods:**
      ...
      Once installed, Sanity MCP tools become available to your Shadow Code agent for all prompts.
    </Tip>
...
Now you can use natural language prompts to manage your Sanity content and schemas. The Shadow Code agent automatically calls the appropriate Sanity MCP tools.
...
This workflow automatically validates your Sanity schemas and content on pull requests using the Shadow Code CLI in [headless mode](/cli/headless-mode). It checks schema integrity, validates content relationships, and posts a summary report as a PR comment.
...
Implement automated content quality checks using Shadow Code's rule system. See the [Rules deep dive](/customize/deep-dives/rules) for authoring tips.
