...
- Read: [Understanding Agents — How to get started with Hub agents](/hub/agents/intro)
  ...
  <Tab title="⚡ Quick Start (Recommended)">
    <Steps>
      <Step title="Load the Pre-Built Agent">
        ...
        ```bash
        cn --agent continuedev/sanity-agent-config
        ```
  ...
  validate-content:
    ...
    steps:
      ...
      - name: Comment Report on PR
        ...
        run: |
          REPORT=$(cn --agent continuedev/sanity-agent-config \
