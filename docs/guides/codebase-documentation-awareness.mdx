...
Modern AI agents work best when they understand the context of your project. This guide shows you how to give your agent access to codebases and documentation, making it more helpful and accurate.
...
<Tip>
Place rules files at different levels of your project hierarchy.
</Tip>

Learn more about [rules configuration](/reference/config/continuerules).
...
[DeepWiki MCP](hub.continue.dev/deepwiki/deepwiki-mcp) lets your agent explore any public GitHub repository.
```
...
For potentially better performance and cost efficiency with large internal codebases, implement [custom code RAG](/guides/customize-chat#codebase-retrieval).
...
- Learn more about [MCP servers](/reference/mcp)
- Explore [rules configuration](/reference/config/continuerules)
