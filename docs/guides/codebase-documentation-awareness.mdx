...
Rules guide agent mode's behavior and understanding. Place markdown files in `.shadow-code/rules` in your project to provide context:
...
2. **Add rules**: Create `.shadow-code/rules` files to provide context about your project structure
...
The new approach provides better integration with Shadow Code's Agent mode features and more intelligent context selection.
