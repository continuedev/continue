---
title: "How to Configure OpenRouter with Yuto Agentic"
sidebarTitle: "OpenRouter"
---

<Tip>
  **Discover OpenRouter models [here](https://yutoagentic.dev/openrouter)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://yutoagentic.dev/openrouter/qwen3-coder?view=config)**
</Info>
...
<Info>
  Yuto Agentic automatically uses system message tools for models that don't support
