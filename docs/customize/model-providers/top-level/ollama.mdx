---
title: "How to Configure Ollama with Yuto Agentic"
slug: ../ollama
sidebarTitle: "Ollama"
---

<Tip>
  **Discover Ollama models [here](https://yutoagentic.dev/lmstudio)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://yutoagentic.dev/ollama/qwen3-coder-30b?view=config)**
</Info>
...
Yuto Agentic may set a higher default context length than other Ollama tools, causing this error even when the model works elsewhere. Fix by reducing `contextLength`:
