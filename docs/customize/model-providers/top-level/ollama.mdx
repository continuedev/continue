---
title: "How to Configure Ollama with Shadow Code"
slug: ../ollama
sidebarTitle: "Ollama"
---
...
Shadow Code may set a higher default context length than other Ollama tools, causing this error even when the model works elsewhere. Fix by reducing `contextLength`:
