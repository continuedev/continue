---
title: "Cohere"
description: "Configure Cohere's AI models with Shadow Code, including setup for Command A for chat, embed-v4.0 for embeddings, and rerank-v3.5 for reranking capabilities"
---
