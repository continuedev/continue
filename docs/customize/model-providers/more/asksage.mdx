...
Follow the steps from the [official Continue docs](https://docs.yutoagentic.dev/cli/quickstart).

2. Setting up a custom config for Ask Sage
Follow the steps in step 2 of the Overview above 👆.

3. How to use Continue CLI
Use [Continue's official guide](https://docs.yutoagentic.dev/guides/cli).
