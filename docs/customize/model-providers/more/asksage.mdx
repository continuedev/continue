...
Add your Ask Sage model to your Shadow Code configuration file, which is located at `~/.shadow-code/config.yaml`. If it does not exist, create it.
...
- Restart Shadow Code to apply changes.
...
## Setting up Shadow Code CLI

1. Install Shadow Code CLI
Follow the steps from the official Shadow Code docs.

2. Setting up a custom config for Ask Sage
Follow the steps in step 2 of the Overview above 👆.

3. How to use Shadow Code CLI
Use Shadow Code's official guide.
