---
title: "Nebius"
description: "Configure Nebius AI Studio with Yuto Agentic to access their language model offerings, including DeepSeek R1 for chat and BAAI embeddings models"
---
