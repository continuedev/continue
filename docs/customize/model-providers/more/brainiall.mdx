---
title: "Brainiall"
description: "Configure Brainiall with Continue to access 33 AI models including Claude, DeepSeek, Llama, Qwen, Mistral, and more through a single OpenAI-compatible API"
---
