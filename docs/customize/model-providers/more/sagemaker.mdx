...
description: "Configure Amazon SageMaker with Shadow Code to use deployed LLM endpoints for both chat and embedding models, supporting LMI and HuggingFace TEI deployments with AWS credentials"
---
