---
title: "Venice AI"
description: "Configure Venice AI with Shadow Code to access this privacy-focused generative AI platform that supports open-source LLMs without storing private user data"
---
...
Change `~/.shadow-code/config.json` to look like the following.
