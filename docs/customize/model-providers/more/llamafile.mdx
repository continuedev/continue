---
title: "Llamafile"
description: "Configure Llamafile with Yuto Agentic to use self-contained binary files that can run open-source language models like Mistral without additional setup"
---
