...
<Tip>
  **Discover Mistral models [here](https://yutoagentic.dev/mistral)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://yutoagentic.dev/mistral/codestral?view=config)**
</Info>
