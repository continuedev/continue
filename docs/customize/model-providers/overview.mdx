...
| [DeepSeek](/customize/model-providers/more/deepseek)           | Specialized models with reasoning, FIM completion, and strong coding capabilities | Chat, Edit, Apply, Reasoning, FIM           |
