---
title: "MCP servers"
description: "Learn how to use Model Context Protocol (MCP) blocks in Shadow Code to integrate external tools, connect databases, and extend your development environment."
---

Model Context Protocol (MCP) servers let Shadow Code connect to external tools, systems, and databases by running MCP servers.
