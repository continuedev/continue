---
title: "MCP servers"
description: "Learn how to use Model Context Protocol (MCP) blocks in Yuto Agentic to integrate external tools, connect databases, and extend your development environment."
---

Model Context Protocol (MCP) servers let Yuto Agentic connect to external tools, systems, and databases by running MCP servers.
