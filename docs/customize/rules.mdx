...
<Columns cols={2}>
<Card title="Local Rules (.yutoagentic/rules)" icon="folder">
- Create files in `.yutoagentic/rules` folder
...
- Manage on [Yuto Agentic Mission Control](https://yutoagentic.dev)
