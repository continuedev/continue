---
title: "How to Collect and Manage Development Data in Shadow Code"
...
When you use Shadow Code, you automatically collect data on how you build software. By default, this development data is saved to `.shadow-code/dev_data` on your local machine.
