...
### Apply Models (Specialized)

| Model                | Provider | Apply |
| :------------------- | -------- | ----- |
| Morph v3             | MorphLLM | ✅    |
| Relace Instant Apply | Relace   | ✅    |

### Autocomplete Models (Specialized)

| Model                  | Provider       | Autocomplete |
| :--------------------- | -------------- | ------------ |
| Codestral ⭐           | Mistral        | ✅           |
...
- **⭐**: Recommended model for this feature
- **Autocomplete**: Code completion (separate from chat models)
