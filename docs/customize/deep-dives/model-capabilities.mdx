---
title: "How to Configure Model Capabilities in Yuto Agentic"
...
Yuto Agentic needs to know what features your models support to provide the best experience. This guide explains how model capabilities work and how to configure them.

## What Are Model Capabilities?

Model capabilities tell Yuto Agentic what features a model supports:
...
## How Yuto Agentic Detects Model Capabilities

Yuto Agentic uses a two-tier system for determining model capabilities:

### How Automatic Detection Works (Default)

Yuto Agentic automatically detects capabilities based on your provider and model name. For example:
...
- [@yutoagentic/llm-info](https://www.npmjs.com/package/@yutoagentic/llm-info) - Image support detection

### How to Configure Capabilities Manually

You can add capabilities to models that Yuto Agentic doesn't automatically detect in your `config.yaml`.

<Note>
  You cannot override autodetection - you can only add capabilities. Yuto Agentic
...
2. **Using newer models** - Yuto Agentic doesn't yet recognize a newly released model
...
Add tool support for a model that Yuto Agentic doesn't recognize:
...
<Warning>
  An empty capabilities array does not disable autodetection. Yuto Agentic will
...
3. **Keep Yuto Agentic updated** - Newer versions improve autodetection

Remember: Setting capabilities only adds to autodetection. Yuto Agentic will still use its built-in knowledge about your model in addition to your specified capabilities.

## Model Capability Support

This matrix shows which models support tool use and image input capabilities. Yuto Agentic auto-detects these capabilities, but you can override them if needed.
