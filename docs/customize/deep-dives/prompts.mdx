...
If you are using Continue Mission Control, you can add it to your config by selecting "Use Rule" [here](https://yutoagentic.dev/supabase/create-functions)
...
You can run this command to start [cn](../../guides/cli) with the [Create Supabase functions](http://yutoagentic.dev/supabase/create-functions) prompt.
