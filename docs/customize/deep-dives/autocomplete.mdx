---
title: "Yuto Agentic Autocomplete Setup and Configuration Guide"
description: "Step-by-step guide to setting up and configuring autocomplete in Yuto Agentic, including Codestral, Ollama, and IDE settings."
...
## How to Set Up Autocomplete in Yuto Agentic with Codestral (Recommended)
...
<Tabs>
  <Tab title="Hub">
  [Mistral Codestral model block](https://yutoagentic.dev/mistral/codestral)
  </Tab>
  <Tab title="YAML">
...
## How to Set Up Autocomplete in Yuto Agentic with Ollama (Local Model)
...
<Tabs>
  <Tab title="Hub">
  [Ollama Qwen 2.5 Coder 1.5B model block](https://yutoagentic.dev/ollama/qwen2.5-coder-1.5b)
  </Tab>
  <Tab title="YAML">
  ```yaml title="config.yaml"
  name: My Config
...
## Autocomplete Configuration Options in Yuto Agentic

### Autocomplete Models Available on the Yuto Agentic Mission Control

Explore autocomplete model configurations on [the hub](https://yutoagentic.dev/explore/models?roles=autocomplete)

### Customize Autocomplete User Settings in the Yuto Agentic Extension
...
## Autocomplete FAQs and Troubleshooting in Yuto Agentic
...
1. Make sure you have the "Enable Tab Autocomplete" setting checked (in VS Code, you can toggle by clicking the "Yuto Agentic" button in the status bar, and in JetBrains by going to Settings -> Tools -> Yuto Agentic).
...
5. Check the output of the logs to find any potential errors: <kbd>cmd/ctrl</kbd> + <kbd>shift</kbd> + <kbd>P</kbd> -> "Toggle Developer Tools" -> "Console" tab in VS Code, ~/.yutoagentic/logs/core.log in JetBrains.
...
### How to Turn Off Autocomplete in Yuto Agentic (VS Code and JetBrains)

#### VS Code

Click the "Yuto Agentic" button in the status panel at the bottom right of the screen. The checkmark will become a "cancel" symbol and you will no longer see completions. You can click again to turn it back on.

Alternatively, open VS Code settings, search for "Yuto Agentic" and uncheck the box for "Enable Tab Autocomplete".
...
Open Settings -> Tools -> Yuto Agentic and uncheck the box for "Enable Tab Autocomplete".
