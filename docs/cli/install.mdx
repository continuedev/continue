...
<Info>
  **Quick Overview**: Continue CLI works in two modes - interactive
  conversations or async, automated commands.
</Info>
...
## Setup for CLI (Continuous AI Mode)
...
<Step title="Test Async Mode">
Try async mode for automation:
```bash
