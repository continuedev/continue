...
### Continuous AI Mode: Production Automation
...
### Development Workflow: REPL → Continuous AI

<Tip>
  **Pro Tip**: Start in REPL mode to iterate on your AI agent and prompts. Once
  you have a workflow that works reliably, deploy it as a Continuous AI
  automation.
</Tip>

1. **Experiment in REPL mode** to perfect your prompts and agent configuration
