...
<Tabs>
  <Tab title="REPL Mode">
    REPL mode (`cn` command) is for **large development tasks** that require
  ...
  <Tab title="Continuous AI Mode">
    Continuous AI mode (`-p` flag) is for **reliable, repeatable tasks** that no
...
## REPL Mode: Large Development Tasks
...
# Start REPL mode for complex development work
cn
```
...
## Continuous AI Mode: Automated Workflows

Once you've refined a workflow in REPL mode, convert it to Continuous AI for automation.

### Example: From REPL → Continuous AI

**Step 1: Develop in REPL mode**
...
### When to Use Continuous AI Mode

✅ **Proven workflows** you've tested in REPL mode  
...
<Info>
  **Recommended Approach**: Start complex tasks in REPL mode to iterate and
  refine your approach. Once you have a reliable workflow, convert it to
  Continuous AI mode for automation.
</Info>

### Workflow Pattern

1. **🔬 Experiment in REPL Mode**
...
<Card title="CLI Configuration" href="/cli/configuration">
  Customize models, rules, and advanced settings
</Card>
