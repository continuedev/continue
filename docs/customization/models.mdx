...
2. Add [Claude 4 Sonnet](https://hub.continue.dev/anthropic/claude-4-sonnet) to an config on Continue Hub
...
2. Add [Qwen Coder 3 480B](https://hub.continue.dev/openrouter/qwen3-coder) to an config on Continue Hub
...
2. Add [GPT-5](https://hub.continue.dev/openai/gpt-5) to an config on Continue Hub
...
1. Get your API key from [OpenRouter](https://openrouter.ai/settings/keys)
2. Add [Kimi K2](https://hub.continue.dev/openrouter/kimi-k2) to an config on Continue Hub
3. Add `OPENROUTER_API_KEY` as a [User Secret](https://docs.continue.dev/hub/secrets/secret-types#user-secrets) on Continue Hub [here](https://hub.continue.dev/settings/secrets)
4. Click `Reload config` in the config selector in the Continue IDE extension
...
2. Add [Gemini 2.5 Pro](https://hub.continue.dev/google/gemini-2.5-pro) to an config on Continue Hub
...
2. Add [Grok Code Fast 1](https://hub.continue.dev/xai/grok-code-fast-1) to an config on Continue Hub
...
2. Add [Devstral Medium](https://hub.continue.dev/mistral/devstral-medium) to an config on Continue Hub
...
1. Get your API key from [OpenRouter](https://openrouter.ai/settings/keys)
2. Add [gpt-oss-120b](https://hub.continue.dev/openrouter/gpt-oss-120b) to an config on Continue Hub
3. Add `OPENROUTER_API_KEY` as a [User Secret](https://docs.continue.dev/hub/secrets/secret-types#user-secrets) on Continue Hub [here](https://hub.continue.dev/settings/secrets)
4. Click `Reload config` in the config selector in the Continue IDE extension
...
1. Add [Qwen3 Coder 30B](https://hub.continue.dev/ollama/qwen3-coder-30b) to an config on Continue Hub
...
1. Add [gpt-oss-20b](ttps://hub.continue.dev/ollama/gpt-oss-20b) to an config on Continue Hub
2. Run the model with [Ollama](https://docs.continue.dev/guides/ollama-guide#using-ollama-with-continue-a-developers-guide)
3. Click `Reload config` in the config selector in the Continue IDE extension

[Devstral Small 27B](https://hub.continue.dev/ollama/devstral)

1. Add [Devstral Small](https://hub.continue.dev/ollama/devstral) to an config on Continue Hub
2. Run the model with [Ollama](https://docs.continue.dev/guides/ollama-guide#using-ollama-with-continue-a-developers-guide)
3. Click `Reload config` in the config selector in the Continue IDE extension

[Qwen2.5-Coder 7B](https://hub.continue.dev/ollama/qwen2.5-coder-7b) from Qwen

1. Add [Qwen2.5-Coder 7B](https://hub.continue.dev/ollama/qwen2.5-coder-7b) to an config on Continue Hub
2. Run the model with [Ollama](https://docs.continue.dev/guides/ollama-guide#using-ollama-with-continue-a-developers-guide)
3. Click `Reload config` in the config selector in the Continue IDE extension

[Gemma 3 4B](https://hub.continue.dev/ollama/gemma3-4b) from Google

1. Add [Gemma 3 4B](https://hub.continue.dev/ollama/gemma3-4b) to an config on Continue Hub
2. Run the model with [Ollama](https://docs.continue.dev/guides/ollama-guide#using-ollama-with-continue-a-developers-guide)
3. Click `Reload config` in the config selector in the Continue IDE extension

[Qwen2.5-Coder 1.5B](https://hub.continue.dev/ollama/qwen2.5-coder-1.5b) from Qwen

1. Add [Qwen2.5-Coder 1.5B](https://hub.continue.dev/ollama/qwen2.5-coder-1.5b) to an config on Continue Hub
2. Run the model with [Ollama](https://docs.continue.dev/guides/ollama-guide#using-ollama-with-continue-a-developers-guide)
3. Click `Reload config` in the config selector in the Continue IDE extension
