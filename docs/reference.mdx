...
**Agents** are composed of reusable **Blocks**, such as models, rules, and MCP servers.

<Columns cols={2}>
<Card title="Understanding Blocks" icon="cube" href="/guides/understanding-blocks">
Learn how to work with Continue's block system, including using hub blocks, creating local blocks, and organizing your configurations.
</Card>
