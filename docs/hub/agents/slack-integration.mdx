...
<Info>
  ...
  **Thread Context**: When you mention @Continue in an ongoing Slack thread, it automatically uses the entire conversation as context, giving your agent full situational awareness.
...
<Accordion title="How Agent Context Works">
