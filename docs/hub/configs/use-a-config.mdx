...
Once you've found the configuration you want to use on Continue Hub:
...
![Extension Config Selector](/images/hub/assistants/images/assistant-extension-select.png)