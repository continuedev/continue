...
description: "Learn how to customize Agent Mode in Shadow Code to better fit your workflow and coding style."
...
- **Ask First (default)**: Request user permission with "Cancel" and "Shadow Code" buttons
