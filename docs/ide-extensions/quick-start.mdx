...
<Tabs>
<Tab title="Agent">
[Agent](/ide-extensions/agent/quick-start) equips the Chat model with the tools needed to handle a wide range of coding tasks

![agent](/images/agent-9ef792cfc196a3b5faa984fb072c4400.gif)

<Info>
  Learn more about [Agent](/ide-extensions/agent/quick-start)
</Info>
</Tab>
...
<Info>
  Learn more about [Chat](/ide-extensions/chat/quick-start)
</Info>
</Tab>
...
<Info>
  Learn more about [Plan](/ide-extensions/agent/plan-mode)
</Info>
</Tab>
