...
description: "Learn Shadow Code's core features through hands-on exercises. Get started with Autocomplete, Edit, Chat, and Agent mode in minutes."
sidebarTitle: "Quick Start"
---

Welcome to Shadow Code! This interactive tutorial will guide you through all four core features using practical examples. Follow along step-by-step to learn more about Shadow Code's capabilities.

<Info>
  **Prerequisites**: Make sure you have [installed
  Shadow Code](/ide-extensions/install) and [signed
...
Press **Enter** and watch Shadow Code suggest code completions. Press **Tab** to accept suggestions.

</Step>

<Step title="See the Magic">
Shadow Code will intelligently suggest function implementations based on the context and comment.
</Step>
</Steps>
...
<Step title="Watch the Magic">
  Watch Shadow Code refactor your code automatically!
</Step>

<Step title="Review Changes">
Shadow Code will show you a diff of the proposed changes. Accept or reject individual changes as needed.
</Step>
</Steps>
...
Ready to explore more? Shadow Code offers five powerful features to enhance your coding workflow:
<Tabs>
...
Congratulations! You've experienced all four core Shadow Code features. Here's what to explore next:
