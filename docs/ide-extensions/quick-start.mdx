...
description: "Learn Yuto Agentic's core features through hands-on exercises. Get started with Autocomplete, Edit, Chat, and Agent mode in minutes."
sidebarTitle: "Quick Start"
---

Welcome to Yuto Agentic! This interactive tutorial will guide you through all four core features using practical examples. Follow along step-by-step to learn more about Yuto Agentic's capabilities.

<Info>
  **Prerequisites**: Make sure you have [installed
  Yuto Agentic](/ide-extensions/install) and [signed
  in](https://auth.yutoagentic.dev/) to get started.
</Info>
...
Press **Enter** and watch Yuto Agentic suggest code completions. Press **Tab** to accept suggestions.

</Step>

<Step title="See the Magic">
Yuto Agentic will intelligently suggest function implementations based on the context and comment.
</Step>
</Steps>
...
<Step title="Watch the Magic">
  Watch Yuto Agentic refactor your code automatically!
</Step>

<Step title="Review Changes">
Yuto Agentic will show you a diff of the proposed changes. Accept or reject individual changes as needed.
</Step>
</Steps>
...
Ready to explore more? Yuto Agentic offers five powerful features to enhance your coding workflow:
<Tabs>
...
Congratulations! You've experienced all four core Yuto Agentic features. Here's what to explore next:
...
<CardGroup cols={2}>
  ...
  >
    Get help and share experiences with other Yuto Agentic users
  </Card>
</CardGroup>
