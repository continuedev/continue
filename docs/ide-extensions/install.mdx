---
title: "Install"
description: "Get Yuto Agentic installed in your favorite IDE in just a few steps."
---
...
<iframe
  ...
  title="Install Yuto Agentic VS Code Extension"
  frameborder="0"
...
Click `Install` on the [Yuto Agentic extension page in the Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=YutoAgentic.yutoagentic)
</Step>

<Step title="Install in VS Code">
  This will open the Yuto Agentic extension page in VS Code, where you will need to
  click `Install` again
</Step>

<Step title="Move to Right Sidebar">
The Yuto Agentic logo will appear on the left sidebar. For a better experience, move Yuto Agentic to the right sidebar
...
<Step title="Sign In">
[Sign in to Mission Control](https://auth.yutoagentic.dev/) to get started
</Step>
</Steps>
...
<Step title="Find Yuto Agentic Plugin">
  Select **Plugins** on the sidebar and search for "Yuto Agentic" in the marketplace
</Step>

<Step title="Install Plugin">
Click `Install`, which will cause the Yuto Agentic logo to show up on the right toolbar
