...
<Step title="Sign In">
[Sign in to Continue](https://auth.continue.dev/) to get started
</Step>
</Steps>
...
Click "Get started" to sign in to Continue and get started.

![Onboarding in the Extension](../images/getting-started/images/hub-onboarding-card-81abd457b6d131c4b0aa89a5a6d647d3.png)
