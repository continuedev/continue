---
title: "Quick Start with Shadow Code Autocomplete"
description: "Learn how to quickly start using Shadow Code's AI autocomplete in your IDE, including enabling inline code suggestions and keyboard shortcuts for accepting, rejecting, or partially accepting completions."
sidebarTitle: "Autocomplete Quick Start"
---

## How to Enable and Use Shadow Code Autocomplete
