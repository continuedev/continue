---
title: "Recommended Models for Autocomplete in Yuto Agentic"
description: "Choose the best autocomplete model for Yuto Agentic, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
...
For proactive code prediction that anticipates your next edit, Yuto Agentic supports specialized [Next Edit](/ide-extensions/autocomplete/next-edit) models:
