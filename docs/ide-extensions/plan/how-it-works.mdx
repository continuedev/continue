...
1. Yuto Agentic sends a special system message instructing the model to focus on understanding and planning
...
<Info>
  ...
  are not filtered by Yuto Agentic. Some MCP tools may have write capabilities that
