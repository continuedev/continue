---
title: "Recommended Models for Chat in Shadow Code"
description: "Choose the best chat model for Shadow Code, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
