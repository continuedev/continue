...
describe('ApiClientService', () => {
  ...
  describe('State Management', () => {
    ...
    test('should initialize with api client when token provided', async () => {
      ...
      const state = await service.initialize({ accessToken: 'test-token' } as any);
  ...
  describe('update()', () => {
    ...
    test('should handle update errors', async () => {
      ...
      await expect(service.update({ accessToken: 'bad-token' } as any)).rejects.toThrow(
  ...
  describe('Event Emission', () => {
    ...
    test('should emit error on update failure', async () => {
      ...
      await expect(service.update({ accessToken: 'bad' } as any)).rejects.toThrow();
