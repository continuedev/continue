...
`;
      ...
      const anthropicMatches = result.match(/uses: anthropic\/claude-4-sonnet/g);
...
`;
      ...
      const result = updateAnthropicModelInYaml(configWithoutModels, testApiKey);
...
`;
      ...
      const result = updateAnthropicModelInYaml(configWithEmptyModels, testApiKey);
