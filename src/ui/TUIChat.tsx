...
const TUIChat: React.FC<TUIChatProps> = ({ assistant, client, initialPrompt }) => {
  ...
  const handleUserMessage = async (message: string) => {
    ...
    if (commandResult) {
      ...
      if (commandResult.output) {
        setMessages(prev => [...prev, { role: 'system', content: commandResult.output! }]);
      }
    ...
    try {
      ...
      const finalAssistantMessage: ChatCompletionMessageParam = { role: 'assistant', content: assistantResponse };
