...
describe("FreeTrialTransitionUI - URL Opening Security", () => {
  ...
  it("should handle URL construction with different base URLs", () => {
    ...
    const testCases = [
      { base: "https://continue.dev", expected: "https://continue.dev/setup-models" },
      { base: "https://app.continue.dev", expected: "https://app.continue.dev/setup-models" },
      { base: "http://localhost:3000", expected: "http://localhost:3000/setup-models" },
    ];
